...
public class WeekRepTalk {
	...
	* 附件集合
	*/
	private List<WeekRepTalkFile> listWeekRepTalkFile;
	/** 
	* 附件主键
	*/
	...
	* 分享人员
	*/
	private List<WeekReportShareUser> listWeekReportShareUser;
	...
	* @return
	*/
	public List<WeekRepTalkFile> getListWeekRepTalkFile() {
		return listWeekRepTalkFile;
	}

	/** 
	* 附件集合
	* @param listWeekRepTalkFile
	*/
	public void setListWeekRepTalkFile(List<WeekRepTalkFile> listWeekRepTalkFile) {
		this.listWeekRepTalkFile = listWeekRepTalkFile;
	}
	...
	* @return
	*/
	public List<WeekReportShareUser> getListWeekReportShareUser() {
		return listWeekReportShareUser;
	}

	/** 
	* 分享人员
	* @param listWeekReportShareUser
	*/
	public void setListWeekReportShareUser(List<WeekReportShareUser> listWeekReportShareUser) {
		this.listWeekReportShareUser = listWeekReportShareUser;
	}
}
