...
public class MsgShareTalk {
	...
	* 附件集合
	*/
	private List<MsgShareTalkUpfile> msgShareTalkUpfiles;
	/** 
	* 分享人员
	*/
	...
	* @return
	*/
	public List<MsgShareTalkUpfile> getMsgShareTalkUpfiles() {
		return msgShareTalkUpfiles;
	}

	/** 
	* 附件集合
	* @param msgShareTalkUpfiles
	*/
	public void setMsgShareTalkUpfiles(List<MsgShareTalkUpfile> msgShareTalkUpfiles) {
		this.msgShareTalkUpfiles = msgShareTalkUpfiles;
	}
