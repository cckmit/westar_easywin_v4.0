...
<body>
<form class="subform" method="post" action="/bgypApply/addBgypApply" id="bgypApplyForm">
<tags:token></tags:token>
<input type="hidden" name="applyCheckState" id="applyCheckState">
<div id="formData">
			...
			<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
            	<div class="widget" style="margin-top: 0px;" >
                	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
                        <span class="widget-caption themeprimary" style="font-size: 20px">申领办公用品</span>
