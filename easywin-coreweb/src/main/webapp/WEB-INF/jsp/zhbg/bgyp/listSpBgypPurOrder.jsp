			...
			<div class="row">
				<div class="col-md-12 col-xs-12 ">
					<div class="widget">
						...
						<div>
							<form action="/bgypPurOrder/listPagedSpBgypPurOrder" id="searchForm" class="subform">
							...
							<c:if test="${empty add}">
								<div class="widget-buttons ps-widget-buttons">
									<button class="btn btn-info btn-primary btn-xs hide" type="button" id="addBgypPurOrder"> <i class="fa fa-plus"></i>采购单录入
									</button>
								</div>
							</c:if>
							</div>
						...
						<div class="widget-body">
									...
									<tbody>
										<c:forEach items="${listBgypPurOrders}" var="purOrderVo" varStatus="vs">
											<tr class="optTr">
												...
												<td>
													<c:choose>
														<c:when test="${purOrderVo.purOrderState eq 0 or purOrderVo.purOrderState eq 1}">--</c:when>
														<c:when test="${purOrderVo.purOrderState eq 2 or purOrderVo.purOrderState eq 3}">
															<div class="ticket-user pull-left other-user-box" 
															data-container="body" data-placement="left">
												...
												<td>
													<c:choose>
														...
														<c:when test="${purOrderVo.purOrderState eq 1}">
															<!-- 待审核  -->
															<a href="javascript:void(0)" busId="${purOrderVo.id}" class="spViewPurOrder">审核</a>
														</c:when>
														<c:when test="${purOrderVo.purOrderState eq 2}">
															<!-- 已入库 -->
							...
							<tags:pageBar url="/bgypPurOrder/listPagedSpBgypPurOrder"></tags:pageBar>
						</div>
						</c:when>
						<c:otherwise>
