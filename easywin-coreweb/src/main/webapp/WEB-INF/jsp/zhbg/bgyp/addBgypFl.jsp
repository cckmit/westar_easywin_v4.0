	...
	<head>
		...
		function optBgypFl(){
		    ...
		    $("#bgypFlForm").ajaxSubmit({
		        type:"post",
		        url:"/bgypFl/ajaxAddBgypFl?sid=${param.sid}&t="+Math.random(),
		        dataType: "json",
		        async:false,
				...
				<div class="col-lg-12 col-sm-12 col-xs-12" >
					<div class="widget" style="border-bottom: 0px">
			        	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
			             	<span class="widget-caption themeprimary ps-layerTitle">新增办公用品分类</span>
											...
											<form class="subform" id="bgypFlForm">
	                                         ...
	                                         <li class="ticket-item no-shadow ps-listline">
												...
												<div class="ticket-user pull-left ps-right-box">
												 ...
												 style="width: 300px;" name="flCode"  value=""/>
												</div>
											</li>
	                                         <li class="ticket-item no-shadow ps-listline">
											    <div class="pull-left gray ps-left-text">
												...
												<div class="ticket-user pull-left ps-right-box">
												 ...
												 style="width: 300px;" name="flName"  value=""/>
												</div>
											</li>
											</form>
										</ul>
