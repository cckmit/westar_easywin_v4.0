...
<script type="text/javascript">
	...
	$(function() {
		...
		getSelfJSON('/bgypPurDetail/listBgypPurDetail',{sid:sid,purOrderId:purOrderId},function(data){
			...
			//初始化数据
			addBgypPurDetailTable(listBgypPurDetails);
		...
		$("body").on("click",".delBgypItem",function(){
			...
			var bgypDetailId = $(ptr).attr("bgypDetailId");
			...
			if(bgypDetailId){
				...
				window.top.layer.confirm("确定删除办公用品?",function(index,layero){
					...
					//取得采购单详情信息
					getSelfJSON('/bgypPurDetail/delBgypPurDetail',{sid:sid,bgypPurDetailId:bgypDetailId},function(data){
						if(data.status=='y'){
							$(ptr).remove();
							//重置索引号
							resetIndex();
...
<body>
<form class="subform" method="post" action="/bgypPurOrder/updateBgypPurOrder" id="bgypPurOrderForm">
<tags:token></tags:token>
<input type="hidden" name="purOrderState" id="purOrderState" value="${bgypPurOrder.purOrderState}">
			...
			<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
            	<div class="widget" style="margin-top: 0px;" >
                	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
                        <span class="widget-caption themeprimary" style="font-size: 20px">编辑采购单</span>
                                         	...
                                         	<div class="pull-left" style="width: 50%">
												...
												<div class="ticket-user pull-left ps-right-box">
												  	<div class="pull-left">
														...
														class="colorpicker-default form-control" type="text" value="${bgypPurOrder.purOrderNum}"
											...
											<div class="pull-left" style="width: 50%">
												...
												<div class="ticket-user pull-left ps-right-box" style="min-width: 135px">
													<tags:userOne datatype="s" name="purUserId" defaultInit="true"
														showValue="${bgypPurOrder.purUserName}" value="${bgypPurOrder.purUserId}" uuid="${bgypPurOrder.purUserImgUuid}"
														filename="${bgypPurOrder.purUserImgName}" gender="${bgypPurOrder.purUserGender}" onclick="true"
	                                          ...
	                                          <div class="pull-left" style="width: 50%">
												...
												<div class="ticket-user pull-left ps-right-box">
												   <input class="colorpicker-default form-control" readonly="readonly"
													...
													value="${bgypPurOrder.bgypPurDate}">
												</div>               
	                                          </div>
	                                          <div class="pull-left" style="width: 50%">
											    <div class="pull-left gray ps-left-text">
												...
												<div class="ticket-user pull-left ps-right-box">
												   <input class="colorpicker-default form-control"
													...
													value="${bgypPurOrder.bgypTotalPrice}">
												...
												<div class="ticket-user pull-left ps-right-box"
													...
													<div class="margin-top-10">
														<div style="clear:both;width: 300px" class="wu-example">
														    ...
														    <c:choose>
																<c:when test="${not empty bgypPurOrder.listBgypPurFiles}">
																	<c:forEach items="${bgypPurOrder.listBgypPurFiles}" var="upfile"
																		varStatus="vs">
															...
															<div style="position: relative; width: 350px; height: 90px;display: none">
																<div style="float: left; width: 250px">
																	<select list="listBgypPurFiles" listkey="upfileId" listvalue="fileName" multiple="multiple" 
																	moreselect="true" style="width: 100%; height: 90px;" id="listBgypPurFiles_upfileId">
																		<c:choose>
																			<c:when test="${not empty bgypPurOrder.listBgypPurFiles}">
																				<c:forEach items="${bgypPurOrder.listBgypPurFiles}"
															...
															<div class="ticket-user pull-left ps-right-box" style="min-width: 135px">
																<div class="ticket-user pull-left">
																	...
																	<img class="user-avatar userImg" style="display:block;float: left"
																		...
																		src="/downLoad/userImg/${bgypPurOrder.comId }/${bgypPurOrder.spUserId}"/>
