...
<body>
	<form class="subform" method="post" action="/car/addMaintainRecord">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
					<div class="widget" style="margin-top: 0px;">
						<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
							<span class="widget-caption themeprimary" style="font-size: 20px">车辆维修记录添加</span>
										...
										<ul class="tickets-list">
											<li class="ticket-item no-shadow autoHeight no-padding">
												...
												<div class="ticket-user pull-left ps-right-box" style="width: 200px;height: auto;">
													<textarea class="colorpicker-default form-control margin-top-10 margin-bottom-10" style="height:55px;width:200px;" id="reason" name="reason" dataType="s"  nullmsg="请填写维修事由!"  placeholder="维修事由……"></textarea>
												</div>
											...
											<li class="ticket-item no-shadow ps-listline">
												<div class="pull-left gray ps-left-text">&nbsp;维修价格(元)</div>
												<div class="ticket-user pull-left ps-right-box">
													<div class="pull-left">
														<input name="maintainPrice" class="colorpicker-default form-control" dataType = "/^\s*$/|/^(([0-9]+)|([0-9]+\.[0-9]{1,2}))$/" errorMsg = "请填入正确的数字！" type="text" value="" style="width: 200px;float: left">
													</div>
												</div>
											</li>
										</ul>
