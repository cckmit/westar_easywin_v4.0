...
<body>
<form class="subform" method="post" action="/rsdaInc/updateRsdaInc">
<input type="hidden" name="id" value="${rsdaInc.id}">
			...
			<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
            	<div class="widget" style="margin-top: 0px;" >
                	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
                        <span class="widget-caption themeprimary" style="font-size: 20px">编辑奖惩信息</span>
									...
									<li class="ticket-item no-shadow ps-listline" style="clear:both">
											...
											<div class="ticket-user pull-left ps-right-box" style="min-width: 135px">
												<tags:userOne datatype="s" name="userId" defaultInit="false"
													showValue="${rsdaInc.userName}" value="${rsdaInc.userId}" comId="${userInfo.comId}"
                                         ...
                                         <li class="ticket-item no-shadow ps-listline">
											...
											<div class="ticket-user pull-left ps-right-box">
											  	<div class="pull-left">
													<input id="incName" datatype="*" name="incName" nullmsg="请填写奖惩项目" 
													class="colorpicker-default form-control" type="text" value="${rsdaInc.incName}"
                                          ...
                                          <li class="ticket-item no-shadow ps-listline" style="clear:both">
											...
											<div class="ticket-user pull-left ps-right-box">
											   <tags:dataDic type="incType" name="incentiveType" datatype="*" id="incType" 
											   please="t" clz="pull-left" value="${rsdaInc.incentiveType}"></tags:dataDic>
											</div>               
                                          </li>
                                          <li class="ticket-item no-shadow ps-listline" style="clear:both">
										    <div class="pull-left gray ps-left-text">
											...
											<div class="ticket-user pull-left ps-right-box">
												<div class="pull-left" style="line-height: 40px;vertical-align: middle;">
												   <input class="colorpicker-default form-control pull-left" datatype="*" readonly="readonly"
													id="incentiveDate" name="incentiveDate" onClick="WdatePicker()" type="text" 
													value="${rsdaInc.incentiveDate}" style="width: 150px" nullmsg="请填写奖惩日期" >
												</div>
											</div>               
                                          </li>
										<li class="ticket-item no-shadow autoHeight no-padding" >
											...
											<div class="ticket-user pull-left ps-right-box" style="width: 400px;height: auto;">
										  		<textarea class="colorpicker-default form-control margin-top-10 margin-bottom-10" style="height:150px;"
										  		 id="remark" name="remark" rows="" cols="">${rsdaInc.remark}</textarea>
											</div> 
												...
												<div class="ticket-user pull-left ps-right-box"
													...
													<div class="margin-top-10">
														<div style="clear:both;width: 300px" class="wu-example">
														    <!--用来存放文件信息-->
														    <div id="thelistlistRsdaIncFiles_upfileId" class="uploader-list">
														    	<c:choose>
																	<c:when test="${not empty rsdaInc.listRsdaIncFiles}">
																		<c:forEach items="${rsdaInc.listRsdaIncFiles}" var="upfile"
																			varStatus="vs">
														    ...
														    <div class="btns btn-sm">
														        <div id="pickerlistRsdaIncFiles_upfileId" class="webuploader-container">
														        	选择文件
														        </div>
														    </div>
															<script type="text/javascript">
																loadWebUpfiles('listRsdaIncFiles_upfileId','${param.sid}','',"pickerlistRsdaIncFiles_upfileId","thelistlistRsdaIncFiles_upfileId",'filelistRsdaIncFiles_upfileId')
															</script>
															<div style="position: relative; width: 350px; height: 90px;display: none">
																<div style="float: left; width: 250px">
																	<select list="listRsdaIncFiles" listkey="upfileId" listvalue="fileName" id="listRsdaIncFiles_upfileId" name="listRsdaIncFiles.upfileId" ondblclick="removeClick(this.id)" 
																		multiple="multiple" moreselect="true" style="width: 100%; height: 90px;">
																			<c:choose>
																				<c:when test="${not empty rsdaInc.listRsdaIncFiles}">
																					<c:forEach items="${rsdaInc.listRsdaIncFiles}"
