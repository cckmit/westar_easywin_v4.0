...
var sid="${param.sid}"
	...
	$(function() {
		...
		$("#addRsdaTrance").on("click",function(){
			$(".subform").submit();
		})
		//部门单选
...
<body>
<form class="subform" method="post" action="/rsdaTrance/addRsdaTrance">
			...
			<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
            	<div class="widget" style="margin-top: 0px;" >
                	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
                        <span class="widget-caption themeprimary" style="font-size: 20px">添加人事调动</span>
                        <div class="widget-buttons ps-toolsBtn">
							<a href="javascript:void(0)" class="blue" id="addRsdaTrance">
										...
										<li class="ticket-item no-shadow ps-listline" style="clear:both">
												...
												<div class="ticket-user pull-left ps-right-box">
													<div class="pull-left" style="line-height: 40px;vertical-align: middle;">
													   <input class="colorpicker-default form-control pull-left" datatype="*" readonly="readonly"
														id="tranceDate" name="tranceDate" onClick="WdatePicker()" type="text" 
														value="" style="width: 150px" nullmsg="&nbsp;">
													</div>
												</div>
											</div>
                                         </li>
                                         <li class="ticket-item no-shadow ps-listline" style="clear:both">
                                         	<div class="pull-left" style="width: 50%">
												...
												<div class="ticket-user pull-left ps-right-box">
												  	<div class="pull-left">
														<input id="trancePreOrg" datatype="*" name="trancePreOrg" nullmsg="&nbsp;" 
                                         	...
                                         	<div class="pull-left" style="width: 50%">
												...
												<div class="ticket-user pull-left ps-right-box">
												  	<div class="pull-left">
												  		<input type="hidden" name="trancePreDepId">
														<input datatype="*" name="trancePreDepName" nullmsg="&nbsp;" 
														class="colorpicker-default form-control" readonly="readonly" type="text" value=""
                                         ...
                                         <li class="ticket-item no-shadow ps-listline" style="clear:both">
                                         	...
                                         	<div class="pull-left" style="width: 50%">
												...
												<div class="ticket-user pull-left ps-right-box">
												  	<div class="pull-left">
												  		<input type="hidden" name="tranceAftDepId">
											...
											<div class="pull-left gray ps-left-text">
												...
												<div class="ticket-user pull-left ps-right-box"
													...
													<div class="margin-top-10">
														<tags:uploadMore name="listTranceFiles.upfileId" showName="fileName"
