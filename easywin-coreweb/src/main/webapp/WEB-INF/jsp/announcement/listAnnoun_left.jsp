            ...
            <div class="page-sidebar" id="sidebar">
                ...
                <ul class="nav sidebar-menu">
                 	<li class="${empty recycleTab?'open':'' }">
                        ...
                        <ul class="submenu">
                            <li class="${(empty recycleTab && (empty param.searchTab || param.searchTab==11))?'active bg-themeprimary':'' }">
                                <a href="javascript:void(0)" onclick="searchAnnounTab(11)">
                                    <span class="menu-text">所有公告</span>
                                </a>
                            </li>
                            <li class="${param.searchTab==12?'active bg-themeprimary':'' }">
                                 <a href="javascript:void(0)" onclick="searchAnnounTab(12)">
                                    <span class="menu-text">我发起的</span>
                                </a>
                            </li>
                            <li class="${param.searchTab==13?'active bg-themeprimary':'' }">
                                <a href="javascript:void(0)" onclick="searchAnnounTab(13)">
                                    <span class="menu-text">关注公告</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="${not empty recycleTab?'open':'' }">
                        <a href="javascript:void(0)" onclick="listRecyBin('039','${param.sid}')">
