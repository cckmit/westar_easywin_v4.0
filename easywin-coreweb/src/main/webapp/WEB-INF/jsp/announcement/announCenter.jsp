...
<script type="text/javascript" src="/static/js/announ/announCenter.js?version=<%=InitServlet.SYSTEM_STARUP_TIME%>"></script>
...
<body>
	...
	<div class="main-container container-fluid">
		...
		<div class="page-container">
			<!-- 大条件 -->
			<jsp:include page="/WEB-INF/jsp/announcement/listAnnoun_left.jsp"></jsp:include>
			<c:choose>
				<c:when test="${not empty recycleTab }">
					<jsp:include page="/WEB-INF/jsp/recycleBin/listPagedPreDel.jsp"></jsp:include>
				</c:when>
				<c:otherwise>
					<jsp:include page="/WEB-INF/jsp/announcement/listAnnoun.jsp"></jsp:include>
				</c:otherwise>
			</c:choose>
