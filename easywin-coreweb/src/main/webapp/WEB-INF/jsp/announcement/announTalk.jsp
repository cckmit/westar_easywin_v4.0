...
<body style="background-color: #ffffff" onload="resizeVoteH('otherannounAttrIframe')" >
<form id="announForm" class="subform">
	<%--当前操作员的回复 --%>
	<div class="parentRep">
		<div class="ws-textareaBox" style="margin-top:10px;">
			...
			<div class="ws-otherBox" style="position: relative;">
				...
				<div class="ws-notice">
					<tags:uploadMore name="listUpfiles_-1.upfileId" showName="filename" ifream="otherannounAttrIframe" comId="${sessionUser.comId}"></tags:uploadMore>
				</div>
			</div>
		</div>
					...
					<div class="shareText">
								...
								<c:forEach items="${talk.listTalkUpfile}" var="upfiles" varStatus="vs">
									<c:choose>
										<c:when test="${upfiles.isPic==1}">
											<p class="p_text">
											附件(${vs.count})：
												<img onload="AutoResizeImage(350,0,this,'otherannounAttrIframe')" src="/downLoad/down/${upfiles.uuid}/${upfiles.filename}?sid=${param.sid}" style="width: 100%;height: 100%;"/>
						...
						<div class="ws-type" >
							<span class="hideOpt" >
								...
								<a id="img_${talk.id}" name="replyImg" onclick="showArea('addTalk${talk.id}','otherannounAttrIframe')"  href="javascript:void(0);" class="fa fa-comment-o" title="回复"></a>
							</span><br>
							<span>
					...
					<div class="shareText">
						<div class="ws-textareaBox" style="margin-top:10px;">
							...
							<div class="ws-otherBox" style="position: relative;">
								...
								<div class="ws-notice">
								<tags:uploadMore
										name="listUpfiles_${talk.id}.upfileId" showName="filename" ifream="otherannounAttrIframe" comId="${sessionUser.comId}"></tags:uploadMore>
								</div>
							</div>
						</div>
					</div>
	...
	<tags:pageBar url="/announcement/announTalkPage"></tags:pageBar>
</form>
