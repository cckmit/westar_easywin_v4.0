						...
						<div class="widget" >
							<div class="widget-header ps-titleHeader bordered-bottom bordered-themeprimary">
								<div class="searchCond">
												...
												<div class="btn-group cond" id="moreCondition_Div">
													...
													<div class="dropdown-menu dropdown-default padding-bottom-10 subMore" style="min-width: 330px;">
														<div class="ps-margin ps-search padding-left-10">
															...
															<input class="form-control dpd2 no-padding condDate" value="${startDate}" type="text" readonly="readonly" id="startDate" name="startDate" placeholder="开始时间"
																onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate: '#F{$dp.$D(\'endDate\',{d:-0});}'})" />
															<span>~</span>
															<input class="form-control dpd2 no-padding condDate" value="${endDate}" type="text" readonly="readonly" id="endDate" name="endDate" placeholder="结束时间"
									...
									<div class="ps-margin ps-search">
										<span class="input-icon">
											<input id="busModName" name="busModName"  
												class="form-control ps-input moreSearch" type="text" placeholder="关联模块关键字">
								...
								<div class="ps-clear" id="formTempData">
									...
									<select list="listBusRemindDep" listkey="id" listvalue="depName" id="sysDep_select" 
										multiple="multiple" moreselect="true" style="display: none">
									</select>
									<select list="listBusRemindUser" listkey="userId" listvalue="userName" id="executor_select" 
										multiple="multiple" moreselect="true" style="display: none">
									</select>
								</div>
								<!-- 筛选条件显示 -->
								<div class="padding-top-5 padding-bottom-5 text-left moreUserListShow" style="display:none" id="executor_selectDiv">
									<strong>被催办人员:</strong>
								</div>
								<!-- 筛选条件显示 -->
