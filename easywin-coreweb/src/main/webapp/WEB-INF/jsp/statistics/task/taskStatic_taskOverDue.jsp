					...
					<div class="widget">
						<div class="widget-header ps-titleHeader bordered-bottom bordered-themeprimary">
							<div id="formDataDiv">
								...
								<button class="btn btn-info  btn-xs" style="display:none" id ="excelExport" onclick="excelExport('逾期统计表')" >导出excel</button>
								</div>
							</div>
...
<script type="text/javascript">
	...
	var url = '/statistics/task/listTaskStatisByType?sid=${param.sid}&statisticsType=2';
		...
		$.each(listBusReport,function(index, obj) {
			...
			$.each(
				...
				function(indexA, vo) {
					...
					if (vo.value) {
						bodyTd = $("<td style='font-size:12px;color:rgb(0,91,255);text-align:center;'><a href='javascript:void(0)' typeId='"+ obj.type+ "' userId='"+ vo.type+ "' userName='"+vo.type+"'>"+ vo.value+ "</a></td>");
					}
