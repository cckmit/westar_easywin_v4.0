...
<body>
<form class="subform" method="post" action="/role/updateRole">
            ...
            <div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
                <div class="widget" style="margin-top: 0px;">
                    <div
                        ...
                        <span class="widget-caption themeprimary" style="font-size: 20px">角色修改</span>
                        <div class="widget-buttons ps-toolsBtn">
                            <a href="javascript:void(0)" class="blue" id="updateRole"> <i
                                                ...
                                                <div class="pull-left col-lg-7 col-sm-7 col-xs-7">
                                                    <div class="row">
                                                        <input id="roleName" datatype="input" name="roleName" type="text" defaultLen="52" class="form-control" placeholder="角色名称"
                                                               nullmsg="请填写角色名称" onpropertychange="handleName()" onkeyup="handleName()" value="${role.roleName}"/>
                                                    </div>
                                                </div>
                                                <div class="pull-left">
                                                ...
                                                <div class="pull-left col-lg-7 col-sm-7 col-xs-7">
                                                    <div class="row">
				                                        <textarea id="roleRemark" name="roleRemark" rows="" cols="" class="form-control"
                                                                  style="width:650px;height: 110px;">${role.roleRemark}</textarea>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
