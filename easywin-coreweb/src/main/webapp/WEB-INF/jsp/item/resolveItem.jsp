...
<body>
<form class="subform" method="post" action="/item/resolveItem">
			...
			<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
            	<div class="widget" style="margin-top: 0px;" >
                	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
                        <span class="widget-caption themeprimary" style="font-size: 20px">分解项目</span>
                            ...
                            <div class="widget-body no-shadow">
                             	<div class="tickets-container bg-white">
									<ul class="tickets-list">
                                         ...
                                         <li class="ticket-item no-shadow ps-listline" style="clear:both">
											...
											<div class="ticket-user pull-left ps-right-box">
												...
												<div style="float: left">
													...
													ondblclick="removeCrm()" readonly style="cursor:auto;width: 250px;float:left" value="" title="双击选择">
													<a href="javascript:void(0)" class="fa fa-chain pull-left" style="float:left;margin-top: 10px;font-size: 18px;padding-left: 10px"  
										...
										<li class="ticket-item no-shadow autoHeight no-padding" id="mans" style="display: ${(item.pubState== 0)?'block':'none'};">
											<div class="pull-left gray ps-left-text padding-top-10">
												&nbsp;分享人</div>
											<div class="ticket-user pull-left ps-right-box"
												style="height: auto;">
