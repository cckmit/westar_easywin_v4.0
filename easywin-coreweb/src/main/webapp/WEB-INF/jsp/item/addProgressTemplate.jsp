...
$(function() {
	...
	$("#addProgressTemplate").click(function(){
		var list = [];
...
function addProgress(a) {
		var html = '<li class="ticket-item no-shadow ps-listline" style="border-bottom: 0">'+
...
<body>
<form class="subform" method="post" action="/itemProgress/addProgressTemplate">
			...
			<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
            	<div class="widget" style="margin-top: 0px;" >
                	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
                        <span class="widget-caption themeprimary" style="font-size: 20px">新建项目进度模板</span>
									...
									<ul class="tickets-list">
                                        <li class="ticket-item no-shadow ps-listline">
											...
											<div class="ticket-user pull-left ps-right-box">
											  	<div class="pull-left">
													<input id="templateName" placeholder="模板名称" datatype="*" name="templateName" 
                                         ...
                                         <li class="ticket-item no-shadow ps-listline" style="border-bottom: 0">
										    <div class="pull-left gray ps-left-text">
										    	&nbsp;模板进度<span style="color: red">*</span>
										    </div>
											<div class="pull-left">
												<input placeholder="阶段名" datatype="*"  name="listsItemTemplateProgress[0].progressName" class="colorpicker-default form-control" type="text" style="width: 200px;float: left" >
											</div>
											<div class="pull-left" style="margin-left: 20px;">
												<input placeholder="排序号" datatype="pn"  name="listsItemTemplateProgress[0].progressOrder" class="colorpicker-default form-control" type="text" style="width: 200px;float: left">
											</div>
											<div class="pull-left" style="margin-left: 20px;">
				                               <a class="ps-point btn-a-full" title="添加" onclick="addProgress(this)">
				                                	<i class="fa green fa-plus"></i>
				                  		...
				                  		<li class="ticket-item no-shadow ps-listline" style="border-bottom: 0">
											...
											<div class="pull-left">
												<input placeholder="阶段名" datatype="*"  name="listsItemTemplateProgress[1].progressName" class="colorpicker-default form-control" type="text" style="width: 200px;float: left" >
											</div>
											<div class="pull-left" style="margin-left: 20px;">
												<input placeholder="排序号" datatype="pn"  name="listsItemTemplateProgress[1].progressOrder" class="colorpicker-default form-control" type="text" style="width: 200px;float: left">
											</div>
											<div class="pull-left" style="margin-left: 20px;">
				                               <a class="ps-point btn-a-full" title="添加" onclick="addProgress(this)">
				                                	<i class="fa green fa-plus"></i>
