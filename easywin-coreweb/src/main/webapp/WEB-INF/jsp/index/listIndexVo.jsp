...
<div class="tit"><span>当前位置：业务模块数据检索</span></div>
<div class="tit" style="margin-top:10px">
<form action="${action}" method="post" id="searchForm" class="searchForm">
	 <input type="hidden" name="redirectPage" id="redirectPage"/>
	 <input type="hidden" name="busType" id="busType" value="${busType}"/>
	...
	<div style="float:left;" id="navmenu">
		<ul  style="float:left;">
			...
			<li style="float:left;height:30px;line-height:30px;position:relative;width:100px;text-align:center;padding-left: 5px">
				<input name="searchStr" id="searchStr" type="text" datatype="*" value="${searchStr}"/>
			</li>
			<li style="float:right;height:30px;line-height:30px;position:relative;width:100px;text-align:center;padding-left:25px;margin-top:5px;">
