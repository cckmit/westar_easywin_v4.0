			...
			<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
            	<div class="widget" style="margin-top: 0px;" >
                	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
                        <span class="widget-caption themeprimary" style="font-size: 20px">添加会议</span>
                        <div class="widget-buttons ps-toolsBtn">
							<a href="javascript:void(0)" class="blue" onclick="addMeet(0)">
										...
										<li class="ticket-item no-shadow ps-listline" >
											...
											<div class="ticket-user pull-left ps-right-box">
												<tags:userOne datatype="s" name="presenter" defaultInit="true"
													...
													onclick="true" showName="presenterName"></tags:userOne>  
											</div> 
											...
											<div class="ticket-user pull-left ps-right-box">
												<tags:userOne datatype="s" name="recorder" defaultInit="true"
													showValue="${userInfo.userName}" value="${userInfo.id}" comId="${userInfo.comId}"
													onclick="true" showName="recorderName"></tags:userOne> 
											</div>               
