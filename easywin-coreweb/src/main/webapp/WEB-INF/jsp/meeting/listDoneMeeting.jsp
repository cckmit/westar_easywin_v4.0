				...
				<div class="col-md-12 col-xs-12 ">
					<div class="widget">
						<div class="widget-header ps-titleHeader bordered-bottom bordered-themeprimary">
							...
							<div>
							<form action="/meeting/listPagedDoneMeeting" class="subform" id="searchForm">
						...
						<c:choose>
							<c:when test="${not empty listMeetings}">
								<div class="widget-body">
											...
											<tbody>
												<c:forEach items="${listMeetings}" var="obj" varStatus="vs">
													<tr class="optTr">
														...
														<td><c:choose>
																<c:when test="${obj.summaryState==0 && userInfo.id==obj.recorder}">
																	<a href="javascript:void(0)" onclick="addSummary('${obj.id}')" style="color: blue">添加</a>
																</c:when>
																<c:otherwise>
																	<a href="javascript:void(0)" onclick="viewSummary('${obj.id}')" style="color: #008000">查看</a>
																</c:otherwise>
															</c:choose></td>
													</tr>
												</c:forEach>
									...
									<tags:pageBar url="/meeting/listPagedDoneMeeting"></tags:pageBar>
								</div>
							</c:when>
							<c:otherwise>
