...
<input type="hidden" name="actInstaceId" id="actInstaceId" value="${meeting.actInstaceId}"/>					
<c:choose>
                     ...
                     <div class="widget-body margin-top-40" id="contentBody" style="overflow: hidden;overflow-y:scroll;">
                     	<div class="widget radius-bordered">
                            ...
                            <div class="widget-body no-shadow">
                          	...
                          	<c:choose>
								<c:when test="${meeting.meetingState==1 && method=='update' }">
                          			<div class="widget radius-bordered collapsed" style="clear:both;display:${meeting.spState==4?'block':'none'}">
			                               <div class="widget-header bg-bluegray no-shadow">
