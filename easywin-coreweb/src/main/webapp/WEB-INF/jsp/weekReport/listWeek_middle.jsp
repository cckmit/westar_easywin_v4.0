			...
			<div class="row">
				<div class="col-md-12 col-xs-12 ">
					<div class="widget">
						<div class="widget-header ps-titleHeader bordered-bottom bordered-themeprimary">
							<div>
									<div class="searchCond" style="display: block">
											...
											<div class="table-toolbar ps-margin">
												<div class="btn-group">
													<a class="btn btn-default dropdown-toggle btn-xs" data-toggle="dropdown" title="部门筛选">
														<c:choose>
															<c:when test="${not empty weekReport.depName}">
																<font style="font-weight:bold;">${weekReport.depName}</font>
															</c:when>
													...
													<ul class="dropdown-menu dropdown-default">
														...
														<c:when test="${not empty listOwners}">
															...
															<c:forEach items="${listOwners}" var="owner" varStatus="vs">
																<li>
																	<a href="javascript:void(0);" onclick="userOneForUserIdCallBack('${owner.id}','weekerId','${owner.userName}','');">${owner.userName}</a>
																</li>
															</c:forEach>
														</c:when>
													</c:choose> --%>
										...
										<div class="ps-margin ps-search">
											<span class="input-icon">
												<input id="weekName" name="weekName" value="${weekReport.weekName}" class="form-control ps-input moreSearch" type="text" placeholder="请输入关键字">
								...
								<div class="widget-buttons ps-widget-buttons">
									<button class="btn btn-primary btn-xs" type="button" onclick="addWeekRep()">
										<i class="fa fa-plus"></i>
										发布周报
									</button>
								</div>
									<div class="ps-clear" id="formTempData">
										<input type="hidden" name="weekYear" id="weekYear" value="${nowYear}">
										<input type="hidden" id="weekerId" name="weekerId" value="${weekReport.weekerId}">
										...
										<input type="hidden" id="weekerType" name="weekerType" value="${weekReport.weekerType}">
										<input type="hidden" id="weekDoneState" name="weekDoneState" value="${weekReport.weekDoneState}">
						...
						<div id="tableShow" style="display: ${(empty param.searchTab || param.searchTab eq 11)?'display':'none'}">
						...
						<div id="lineShow" style="display: ${(not empty param.searchTab and param.searchTab ne 11)?'display':'none'}">
							<div class="box">
									<ul class="event_year">
									</ul>
									<ul class="event_list">
									...
									<div style="text-align: center;">
										<a href="javascript:void(0);" id="weekRepMore">加载更多</a>
									</div>
								</div>
