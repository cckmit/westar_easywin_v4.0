...
<c:if test="${param.searchTab==11 || param.searchTab==12 || param.searchTab==13}">
	<link rel="stylesheet" type="text/css" href="/static/plugins/weekrepline/css/about.css" />
</c:if>
...
var pageParam = {
		...
		"searchTab":"${empty param.searchTab?'11':param.searchTab}",
		"userInfo":{
			"id":${userInfo.id}
		}
}
	...
	<!-- 系统头部装载 -->
	    ...
	    <div class="main-container container-fluid">
	        ...
	        <div class="page-container">
	        	<!-- 大条件 -->
				<jsp:include page="/WEB-INF/jsp/weekReport/listWeek_left.jsp"></jsp:include>
				<c:choose>
					<c:when test="${param.searchTab==21}">
						<!-- 配置-->
						<jsp:include page="/WEB-INF/jsp/weekReport/addWeekRepMod.jsp"></jsp:include>
					</c:when>
					<c:otherwise>
						<!-- 列表-->
						<jsp:include page="/WEB-INF/jsp/weekReport/listWeek_middle.jsp"></jsp:include>
					</c:otherwise>
				</c:choose>
	        </div>
	   		 <!--主题颜色设置按钮-->
...
<c:if test="${empty param.searchTab || param.searchTab==11 || param.searchTab==12 || param.searchTab==13}">
	<script type="text/javascript" src="/static/js/weekJs/weekreport_center.js?version=<%=InitServlet.SYSTEM_STARUP_TIME%>"></script>
</c:if>
</html>
