										...
										<div class="table-toolbar ps-margin">
											<div class="btn-group">
												...
												<ul class="dropdown-menu dropdown-default">
													...
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="busTripState" dataValue="1">出差借款</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="busTripState" dataValue="0">一般借款</a>
													</li>
												</ul>
											</div>
										</div>
										<div class="table-toolbar ps-margin">
											<div class="btn-group">
												...
												<ul class="dropdown-menu dropdown-default">
													...
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="status" dataValue="1">借款通过</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="status" dataValue="-1">借款失败</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="status" dataValue="0">借款审批中</a>
													</li>
												</ul>
											</div>
										</div>
