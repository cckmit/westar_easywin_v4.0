					...
					<div class="widget">
							...
							<div>
									<div class="btn-group pull-left searchCond">
										...
										<div class="table-toolbar ps-margin" style="display:${isForceInPersion eq true ? 'block':'none'}">
											<div class="btn-group">
												<a class="btn btn-default dropdown-toggle btn-xs" data-toggle="dropdown" title="借款人员">
													借款人员
													<i class="fa fa-angle-down"></i>
												</a>
												<ul class="dropdown-menu dropdown-default">
										...
										<div class="table-toolbar ps-margin">
											...
											<a class="btn btn-default dropdown-toggle btn-xs" data-toggle="dropdown" title="借款状态">
													<c:choose>
			                                                <c:when test="${not empty param.status}">
			                                                    <font style="font-weight:bold;">
			                                                        <c:choose>
			                                                            <c:when test="${param.status==5}">已领款</c:when>
			                                                        </c:choose>
			                                                        <c:choose>
			                                                            <c:when test="${param.status==1}">申请中</c:when>
			                                                        </c:choose>
			                                                    </font>
			                                                </c:when>
												...
												<ul class="dropdown-menu dropdown-default">
													...
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="status" dataValue="5">已领款</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="status" dataValue="4">待领款</a>
													</li>
													<!-- 
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="status" dataValue="3">待借款</a>
													</li>
													 -->
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="status" dataValue="-1">借款失败</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="status" dataValue="1">申请中</a>
													</li>
												</ul>
											</div>
										</div>
								...
								<c:if test="${empty add}">
									<div class="widget-buttons ps-widget-buttons">
										<button class="btn btn-info btn-primary btn-xs margin-left-5" type="button" 
										 name="addLoanBtn" onclick="javascript:void(0);"><i class="fa fa-plus"></i>我要借款</button>
									</div>
								</c:if>
							</div>
						...
						<div class="widget-body" id="infoList">
							<table class="table table-bordered ">
								<thead>
									<tr role="row">
										<th style="text-align: center;font-weight:bold;width: 30px;padding: 0">
											序
										</th>
										...
										<th style="text-align: center;font-weight:bold;width: 120px;padding: 0">
											借款日期
										</th>
										<th style="text-align: center;font-weight:bold;width: 90px;padding: 0">
											申请金额
										</th>
										<th style="text-align: center;font-weight:bold;width: 90px;padding: 0">
											借款金额
