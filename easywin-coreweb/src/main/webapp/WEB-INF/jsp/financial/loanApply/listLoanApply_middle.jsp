                    ...
                    <div class="table-toolbar ps-margin">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                                ...
                                <li>
                                    <a href="javascript:void(0)" class="setValue" relateElement="status" dataValue="1">审核通过</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="setValue" relateElement="status" dataValue="-1">审核失败</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="setValue" relateElement="status" dataValue="0">审批中</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="widget-body" style="min-height: 550px">
            ...
            <table class="table table-bordered" id="editabledatatable">
                ...
                <tr role="row">
                    ...
                    <th style="text-align: center;font-weight:bold;width:150px;padding: 0 0">
                        项目/客户
                    </th>
                    ...
                    <!-- <th style="text-align: center;font-weight:bold;width: 60px;padding: 0 0 !important;">
                        报销次数<br>
                        <i class="fa fa-check green" title="申请成功"></i>
                        |
                        <i class="fa fa-gavel blue" title="审批中"></i>
                    </th>
                    <th style="text-align: center;font-weight:bold;width: 55px;padding: 0 0">
                        报销中
                    </th> -->
