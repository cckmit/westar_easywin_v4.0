...
$(function(){
	...
	$("#consumeUpfileMenuLi").click(function(){
		...
		$("#otherCustomerAttrIframe").attr("src","/consume/consumeUpfilePage?sid=${param.sid}&pager.pageSize=10&consumeId=${consume.id}&redirectPage="+encodeURIComponent(window.location.href));
	});
	//消费记录详情
			...
			<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
            	<div class="widget" style="margin-top: 0px;" >
                	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
                        ...
                        <span class="widget-caption themeprimary" style="font-size: 20px">消费记录编辑
                        </span>
                                	 ...
                                	 <div class="tabbable">
                                    	 ...
                                    	 <div class="tab-content tabs-flat" style="padding-left: 0px">
                                    	 	<div id="consumeBase" style="display:block;">
												<jsp:include page="./consumeBase_edit.jsp"></jsp:include>
											</div>
