        ...
        <div class="row" style="margin: 0 0">
            <div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
                <div class="widget" style="margin-top: 0px;" >
                    ...
                    <div class="widget-body  margin-top-40" id="contentBody" style="overflow: hidden;overflow-y:scroll;width: 100%;height: 900px;">
                        <div class="widget-body no-shadow">
                            <div class="widget-main ">
                                <iframe id="otherAttrIframe" class="layui-layer-load"
                                        src="/financial/personalApply/detailsLoanViewPage?sid=${param.sid}&loanApplyInsId=${loan.loanApplyInsId}&instanceId=${loan.instanceId}&ifreamName=otherAttrIframe"
