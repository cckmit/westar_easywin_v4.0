...
<div class="content-wrapper">
    <div class="content-head">
        <div class="tab-nav">
            <div class="item" id="loanOffApply" onclick="parent.listMyLoanOffPage()">报销申请
            ...
            <div class="item item-active" onclick="parent.listMyConsumePage()">待销消费记录
...
<div class="widget-header ps-titleHeader bordered-bottom bordered-themeprimary" style="border-bottom: 0">
	...
	<div>
	<form action="/financial/personalApply/listMyConsumePage" class="subform" id="searchForm">
		...
		<div class="widget-buttons ps-widget-buttons" style="padding-top: 10px;">
...
<c:choose>
	<c:when test="${not empty listConsumes}">
		<div class="widget-body">
				...
				<table class="table table-striped table-hover" style="font-size: 13px;">
					<thead>
						<tr role="row">
							...
							<th width="8%" valign="middle">类型</th>
							<th width="10%" valign="middle">金额</th>
							<th width="10%" valign="middle">消费日期</th>
							<th width="14%" valign="middle">地点</th>
							<th valign="middle">描述</th>
							<th width="8%" valign="middle">发票数量</th>
							<th width="14%" valign="middle">创建时间</th>
							<th width="8%" valign="middle">状态</th>
							<th width="100px" valign="middle" style="text-align: center;">操作</th>
						</tr>
					</thead>
					<tbody>
			...
			<tags:pageBar url="/financial/personalApply/listMyConsumePage"></tags:pageBar>
		</div>
	</c:when>
	<c:otherwise>
...
$(function(){
	...
	$("body").on("click",".moreSearchBtn,.ps-searchBtn",function(){
        var val = $(this).parent.find(".moreSearch").val();
