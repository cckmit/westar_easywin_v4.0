	...
	function formSub(){
		...
		$(".subform").ajaxSubmit({
		        ...
		        beforeSubmit:function (a,f,o){
		        	...
		        	if(strIsNull(expectTime)){
		        		scrollToLocation($("#contentBody"),$("#expectTime"));
	                    layer.tips("请填写完成时限",$("#expectTime"),{"tips":1});
		        		return false;
		        	}
					var stepTag = $("#stepTag").val();
		        	if(strIsNull(stepTag)){
		        		scrollToLocation($("#contentBody"),$("#stepTag"));
			                            ...
			                            <div class="tickets-container tickets-bg tickets-pd clearfix">
			                                <ul class="tickets-list clearfix">
			                                    <li class="ticket-item no-shadow clearfix ticket-normal pull-left col-lg-6 col-sm-6 col-xs-6">
			                                        ...
			                                        <div class="pull-left col-lg-5 col-sm-5 col-xs-5">
			                                        	<div class="row">
				                                            <tags:dataDic type="taskType" name="taskType" id="taskType" value="2" style="width:150px"></tags:dataDic>
			                                            </div>
			                                        </div>
			                                    </li>
			                                    <li class="ticket-item no-shadow clearfix ticket-normal pull-left col-lg-6 col-sm-6 col-xs-6">
			                                        ...
			                                        <div class="pull-left col-lg-5 col-sm-5 col-xs-5">
			                                        	<div class="row">
				                                            <input type="text" class="form-control" placeholder="完成时限" 
				                                            	datatype="ff,pff" id="expectTime" name="expectTime" style="width:150px"/>
														</div>
			                                ...
			                                <ul class="tickets-list clearfix padding-top-10">
			                                    <li class="ticket-item no-shadow clearfix ticket-normal pull-left col-lg-6 col-sm-6 col-xs-6">
			                                        ...
			                                        <div class="pull-left col-lg-5 col-sm-5 col-xs-5">
			                                        	<div class="row">
				                                            <tags:dataDic type="grade" name="grade" id="grade" style="width:150px"></tags:dataDic>
			                                            </div>
			                                        </div>
			                                    </li>
			                                    <li class="ticket-item no-shadow clearfix ticket-normal pull-left col-lg-6 col-sm-6 col-xs-6">
			                                        ...
			                                        <div class="pull-left col-lg-5 col-sm-5 col-xs-5">
			                                        	<div class="row pull-left">
			                                        		<tags:dataDic type="stepTag" name="stepTag" id="stepTag" datatype="*" please="t" style="width:150px" ></tags:dataDic>
														</div>
			                                        </div>
			                                    </li>
			                                </ul>
