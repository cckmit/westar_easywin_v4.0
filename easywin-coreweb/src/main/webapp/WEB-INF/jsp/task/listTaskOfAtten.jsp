            ...
            <div class="col-md-9 col-xs-12 no-padding-right">
                <div class="widget">
                    <div class="widget-header ps-titleHeader bordered-bottom bordered-themeprimary">
                        ...
                        <div>
                            <form action="/task/listTaskOfAttenPage" id="searchForm" class="subform">
                    ...
                    <c:choose>
                        <c:when test="${not empty list}">
                            <div class="widget-body">
                                    ...
                                    <table class="table table-striped table-hover fixTable" id="editabledatatable">
                                        ...
                                        <c:forEach items="${list}" var="taskVo" varStatus="vs">
                                            <tr class="optTr" taskID="${taskVo.id}" style="clear: both">
                                                ...
                                                <td class="no-padding-left no-padding-right"><span class="label ${gradeColor}"> <c:choose>
                                ...
                                <tags:pageBar url="/task/listTaskOfAttenPage"></tags:pageBar>
                            </div>
                        </c:when>
                        <c:otherwise>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#searchForm").ajaxSubmit({
            type:"POST",
            url:"/task/ajaxAllTaskCount?entry=3&t="+Math.random(),
            dataType:"json",
            data:selectData,
            beforeSend: function(){
        ...
        $("#subDiv").on("click","a",function(){
            ...
            if(executor || operatorNotExecutor){
                ...
                //         if(inputVal && inputName!='activityMenu'){
