...
<%@taglib prefix="fmt" uri="/WEB-INF/tld/fmt.tld"%>
			...
			<div class="row">
				<div class="col-md-9 col-xs-12 ">
					<div class="widget">
						...
						<div>
                            <form action="/task/listTaskOfMinePage" id="searchForm" class="subform">
						...
						<div class="widget-body">
							...
							<tags:pageBar url="/task/listTaskOfMinePage"></tags:pageBar>
						</div>
						</c:when>
					<c:otherwise>
    ...
    $(function(){
        ...
        $("#searchForm").ajaxSubmit({
            type:"POST",
            url:"/task/ajaxAllTaskCount?entry=4&t="+Math.random(),
            dataType:"json",
            data:selectData,
            beforeSend: function(){
