...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            //列出被复制任务的执行人
            /* listExecutors(${task.id},function(data){
                if(data.status=='y'){
                    var executors = data.executors;
                    $.each(executors,function(index,userObj){
                        var relateSelect = $(".exectorSelectBtn").attr("relateSelect");
                        var relateImgDiv = $(".exectorSelectBtn").attr("relateImgDiv");
                        taskOptForm.appendUsedUser(userObj,relateSelect,relateImgDiv)
                    })
                    ...
                    <div
                        ...
                        <div class="widget-buttons ps-toolsBtn">
                            <a href="javascript:void(0)" class="blue"
                               onclick="setAtten(this)"> <i class="fa fa-star-o"></i>关注 </a>
                            <!-- <a href="javascript:void(0)" class="blue" id="addTask"> <i
                                class="fa fa-save"></i>复制 </a> -->
                        </div>
                                        ...
                                        <div class="tickets-container tickets-bg tickets-pd clearfix">
                                            <ul class="tickets-list clearfix">
                                                ...
                                                <li class="ticket-item no-shadow clearfix ticket-normal pull-left col-lg-4 col-sm-4 col-xs-4">
                                                    ...
                                                    <div class="pull-left col-lg-5 col-sm-5 col-xs-5">
                                                        <div class="row">
                                                            <input type="text"  datatype="*" class="form-control" placeholder="完成时限" readonly="readonly" id="dealTimeLimit"
                                                                   name="dealTimeLimit" onClick="WdatePicker({minDate:'%y-%M-{%d}'})" value="${task.dealTimeLimit}"/>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="ticket-item no-shadow clearfix ticket-normal pull-left col-lg-4 col-sm-4 col-xs-4">
                                                    <div class="pull-left task-left-text task-height">紧急度：</div>
                                                    <div class="pull-left col-lg-5 col-sm-5 col-xs-5">
                                                        <div class="row">
                                                ...
                                                <div class="pull-left col-lg-7 col-sm-7 col-xs-7">
                                                    <div class="row">
				                                        <textarea id="taskRemark" name="taskRemark" rows="" cols="" class="form-control"
                                                                  style="width:650px;height: 110px;display:none;">${task.taskRemark}</textarea>
                            ...
                            <div class="widget no-header ">
                                <div class="widget-body bordered-radius">
                                    <div class="tickets-container tickets-bg tickets-pd">
                                        <ul class="tickets-list">
                                            <li class="ticket-item no-shadow clearfix ticket-normal">
                                                <div class="pull-left task-left-text task-height" style="text-align: right;">附件：</div>
