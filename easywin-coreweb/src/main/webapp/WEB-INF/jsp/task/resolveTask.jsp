										...
										<div class="task-describe clearfix">
											<div class="tickets-container tickets-bg tickets-pd clearfix">
												<ul class="tickets-list clearfix">
													...
													<li class="ticket-item no-shadow clearfix ticket-normal pull-left col-lg-4 col-sm-4 col-xs-4">
														<div class="pull-left  ps-left-text padding-top-10" style="text-align: right;"><span style="color: red">*</span>完成时限：</div>
														<div class="pull-left col-lg-5 col-sm-5 col-xs-5">
															<div class="row">
																<input type="text" class="form-control" placeholder="完成时限" readonly="readonly" id="dealTimeLimit" name="dealTimeLimit" onClick="WdatePicker({minDate:'%y-%M-{%d}'})" />
															</div>
														</div>
													</li>
													<li class="ticket-item no-shadow clearfix ticket-normal pull-left col-lg-4 col-sm-4 col-xs-4">
