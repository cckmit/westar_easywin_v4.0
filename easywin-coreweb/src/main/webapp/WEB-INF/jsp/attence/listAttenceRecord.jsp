				...
				<div class="col-md-12 col-xs-12 ">
					<div class="widget">
						<div class="widget-header ps-titleHeader bordered-bottom bordered-themeprimary">
							<div>
								<form action="/attence/listAttenceRecord" id="searchForm" class="subform">
									...
									<input type="hidden" name="userId" value="${attenceRecord.userId}">
									<input type="hidden" name="userName" value="${attenceRecord.userName}">
									...
									<div class="btn-group pull-left searchCond">
										<div class="table-toolbar ps-margin">
											...
											<div class="btn-group">
												...
												<c:choose>
													<c:when test="${not empty attenceRecord.userId }">${attenceRecord.userName}</c:when>
													<c:otherwise>人员筛选</c:otherwise>
												</c:choose>
												<i class="fa fa-angle-down"></i>
												</a>
												<ul class="dropdown-menu dropdown-default">
													<li> <a href="javascript:void(0)"  class="userOneElementSelect" relateElement='userId' relateElementName='userName'>人员选择</a></li>
												</ul>
											</div>
										</div>
										...
										<tbody>
											<c:forEach items="${listAttenceRecord}" var="obj" varStatus="vs">
												<tr class="optTr">
													...
													<td class="text-center">${attenceRecord.userName}</td>
