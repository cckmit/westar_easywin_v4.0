				...
				<div class="col-md-12 col-xs-12 ">
					<div class="widget">
						<div class="widget-header ps-titleHeader bordered-bottom bordered-themeprimary">
							<div>
								<form action="/attence/attenceStatistics" id="searchForm" class="subform">
						...
						<c:choose>
							<c:when test="${not empty listUserInfo}">
								<div class="widget-body">
										...
										<tbody>
											<c:forEach items="${listUserInfo}" var="userInfoVo" varStatus="vs">
												<tr class="optTr">
													...
													<td class="text-center">
														<c:choose>
															<c:when test="${userInfoVo.leaveTotal ne '0.0' and userInfoVo.leaveTotal ne '0'}">
													...
													<td class="text-center">
														<c:choose>
															<c:when test="${not empty userInfoVo.overTime.overTimeTotal and userInfoVo.overTime.overTimeTotal ne '0.0' and userInfoVo.overTime.overTimeTotal ne '0'}">
									...
									<tags:pageBar url="/attence/attenceStatistics"></tags:pageBar>
								</div>
							</c:when>
							<c:otherwise>
