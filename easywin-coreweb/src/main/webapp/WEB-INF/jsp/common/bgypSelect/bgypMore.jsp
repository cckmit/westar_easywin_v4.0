							...
							<td style="padding-right:0px;">
								<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
									<tr bgcolor="#FFFFFF">
										...
										<td width="200px;" style="vertical-align: top;border: 1px solid #86B1E8;">
											<div
												style="overflow:hidden;overflow-y:auto;position: relative;height: 430px;width: 200px">
												<ul id="bgypFlTree" class="ztree"></ul>
											</div>
										</td>
										<td style="padding-left: 1px;"></td>
										<td bgcolor="#FFFFFF" width="420px" 
											style="vertical-align: top;border: 1px solid #86B1E8;" id="infoList">
												<div style="width: 100%">
													<table class="table table-hover general-table">
														<thead>
															<tr style="display:block;">
															  <th style="text-align:left;width:38px;padding-left:5px !important;">选择</th>
															  <th style="text-align:left;width:178px">用品名称</th>
															  <th style="text-align:left;width:100px">类别</th>
															  <th style="text-align:center;width:38px">单位</th>
															  <th style="text-align:center;width:68px">规格</th>
															</tr>
														</thead>
													</table>
												</div>
...
function zTreeOnClick(event, treeId, treeNode) {
    ...
    if(treeNode.level>0){
    	...
    	$.getJSON('/bgypItem/ajaxListBgypItem4FlWithSub', {random : Math.random(),sid:sid,flId:flId},function(data){
    		var listBgypItem = data.listBgypItem;
    		
    		$("#bgypItemList").html('');
    		if(listBgypItem && listBgypItem.length>0){
    			$.each(listBgypItem,function(index,obj){
    				var $tr = $("<tr style='width:430px'></tr>");
    				var $td0 = $("<td valign='middle' style='width:38px !important;padding-left:5px !important;' class='no-padding-top no-padding-bottom no-margin'><label class='no-margin-bottom'><input class='colored-blue' type='checkbox'/><span class='text' style='color: inherit;'></span></label></td>");
    				var $td1 = $("<td valign='middle' style='text-align:left;width:width:178px !important;'>["+obj.bgypCode+"]"+obj.bgypName+"</td>");
    				var $td2 = $("<td valign='middle' style='text-align:left;width:100px !important;'>"+obj.flName+"</td>");
    				var $td3 = $("<td valign='middle' style='text-align:center;width:38px !important;'>"+obj.bgypUnitName+"</td>");
    				var $td4 = $("<td valign='middle' style='text-align:center;width:68px !important;'>"+(obj.bgypSpec ? obj.bgypSpec :"/")+"</td>");
