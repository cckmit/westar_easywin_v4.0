		...
		<div class="col-lg-12 col-sm-12 col-xs-12" >
			<div class="widget" style="border-bottom: 0px">
	        	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
	             	<span class="widget-caption themeprimary ps-layerTitle">人员单选</span>
						...
						<tr bgcolor="#FFFFFF">
							<td height="27" align="left">
								<table width="98%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td align="left">
											<form id="subform" action="/common/userOneSelect/userTable" target="usertree">
												...
												&nbsp;&nbsp;<input style="height: 20px;border:1px solid #dddddd;" name="queryName" id="queryName" onblur="blurName(this);" onfocus="focusName(this);" tip="请输入机构名称" value="请输入机构名称" class="gray" onkeydown="enter();"/>
							...
							<td style="padding-right: 10px;">
								<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
									<tr style="background-color: #fff">
										...
										<td width="220px;"><iframe id="deptree" name="deptree" style="width: 100%;height:400px; border: 1px solid #86B1E8;" frameborder="0" src="/common/userOneSelect/orgTreePage?sid=${param.sid }"></iframe></td>
...
<script type="text/javascript">
	...
	function listuser(anyDepId) {
		usertree.location.href = "/common/userOneSelect/userTable?anyDepId="+ anyDepId+"&sid=${param.sid}&forMeDoDis=${param.forMeDoDis}&onlySubState=${param.onlySubState}";
	}
    //根据分组查询人员
    function listUserByGroup(groupId){
    	usertree.location.href = "/common/userOneSelect/group/userTable?groupId="+ groupId+"&sid=${param.sid}&forMeDoDis=${param.forMeDoDis}&onlySubState=${param.onlySubState}";
    }
    //根据角色查询人员
    function listUserByRole(roleId){
        usertree.location.href = "/common/role/userTable?roleId="+ roleId+"&sid=${param.sid}&forMeDoDis=${param.forMeDoDis}&onlySubState=${param.onlySubState}";
    }
	...
	$(function() {
		...
		var usernameValue = '${param.userName}';
		if(usernameValue){
			removeOptions("userselect");
			$('#userselect').append("<option value='"+useridValue+"'>" + usernameValue + "</option>");
		}
		usertree.location.href = "/common/userOneSelect/group/userTable?sid=${param.sid}&forMeDoDis=${param.forMeDoDis}&onlySubState=${param.onlySubState}";
	})
