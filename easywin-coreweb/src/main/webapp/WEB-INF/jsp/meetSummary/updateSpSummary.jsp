...
$(function() {
	...
	$("#meetLogLi").click(function(){
		...
		$("#otherAttrIframe").attr("src","/common/listLog?sid=${param.sid}&pager.pageSize=10&busId=${meeting.id}&busType=017&ifreamName=otherAttrIframe");
	});
	//会议审批记录
	$("#spFlowRecordLi").click(function(){
		...
		$("#otherAttrIframe").attr("src","/modFlow/listSpHistory?sid=${param.sid}&busId=${meeting.id}&busType=017&doneState=1&spState=${meeting.spState}&ifreamName=otherAttrIframe");
	});
	//会议审批记录
...
function checkForm(){
	...
	if(filesLen>0 || summary){//有会议纪要
		var flag = ModFlowBase.checkModFlowConfigForUpdate();
	    if(flag){
                                	 ...
                                	 <div class="tabbable">
                                    	 ...
                                    	 <div class="tab-content tabs-flat">
                                    	 	<div id="meetSummaryBase" style="display:block;">
												<jsp:include page="./meetSpSummary_edit.jsp"></jsp:include>
											</div>
