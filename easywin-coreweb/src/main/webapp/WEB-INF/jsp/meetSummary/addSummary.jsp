            	...
            	<div class="widget" style="margin-top: 0px;" >
                	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
                        ...
                        <div class="widget-buttons ps-toolsBtn">
                        	<c:choose>
                        		<c:when test="${meetSummary.spState eq  0 && (empty meetSummary.listSummaryFile and empty meetSummary.summary )}">
									<a href="javascript:void(0)" class="blue" onclick="addMeetSummary(0)">
										<i class="fa fa-save" ></i>发布
									</a>
									<a href="javascript:void(0)" class="blue" onclick="addMeetSummary(1)">
										<i class="fa fa-save" ></i>送审
									</a>
                        		</c:when>
                        		<c:when test="${meetSummary.spState eq  -1}">
									<a href="javascript:void(0)" class="blue" onclick="addMeetSummary(1)">
										<i class="fa fa-save" ></i>送审
									</a>
                        		</c:when>
                        		
                        		<c:when test="${meetSummary.spState eq  0  && ( not empty meetSummary.listSummaryFile or not empty meetSummary.summary )}">
									<a href="javascript:void(0)" class="blue fa fa-edit" id="edit">
										编辑
									</a>
									<a href="javascript:void(0)" class="blue fa fa-close hide" id="cancle">
										取消
									</a>
									<a href="javascript:void(0)" class="blue fa fa-save hide" id="save">
										保存
									</a>
                        		</c:when>
                        		<c:otherwise>
                                	 ...
                                	 <div class="tabbable">
                                    	 ...
                                    	 <div class="tab-content tabs-flat">
                                    	 	<div id="meetSummaryBase" style="display:block;">
												<jsp:include page="./meetSummary_edit.jsp"></jsp:include>
											</div>
