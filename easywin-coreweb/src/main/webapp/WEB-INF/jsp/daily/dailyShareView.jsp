...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#msgShareLogMenuLi").click(function(){
            ...
            $(this).parent().find("li").removeAttr("class");
            $(this).attr("class","active");
            $("#otherIframe1").attr("src","/common/listLog?sid=${param.sid}&pager.pageSize=10&busId=${daily.id}&busType=050&ifreamName=otherIframe1");
        });
        //分享信息文档
        $("#msgShareUpfileMenuLi").click(function(){
            ...
            $(this).parent().find("li").removeAttr("class");
            $(this).attr("class","active");
            $("#otherIframe1").attr("src","/daily/dailyFilePage?sid=${param.sid}&pager.pageSize=10&dailyId=${daily.id}&mouldViewType=${mouldViewType}");
        });
        //分享查看记录
            ...
            <div class="widget no-margin-bottom" style="margin-top: 0px;">
                <div
                    ...
                    <span class="widget-caption pull-left margin-left-10 ">
							${daily.userName}：${daily.dailyDate}
						</span>
                    <div class="widget-buttons ps-toolsBtn">
                        <a href="javascript:void(0)" class="blue"
                           attentionState="${daily.attentionState}" busType="050"  busId="${daily.id}"  describe="1" iconSize="sizeMd"
                           onclick="changeAtten('${param.sid}',this)">
                            <i class="fa ${daily.attentionState==0?'fa-star-o':'fa-star ws-star'}"></i>
                            ${daily.attentionState==0?'关注':'取消'} </a>
                    ...
                    <div class="widget-body margin-top-10" id="contentBody1"
                        ...
                        <ul class="nav nav-tabs tabs-flat">
                            ...
                            <li id="msgShareUpfileMenuLi"><a
                                ...
                                <c:if test="${daily.fileNum > 0}"><span style="color:red;font-weight:bold;">（${daily.fileNum}）</span></c:if>
                            </a>
                            </li>
                            <li id="msgShareLogMenuLi"><a href="javascript:void(0)" data-toggle="tab">日志记录</a></li>
                        </ul>
