			...
			<div class="col-md-12 col-xs-12 ">
				<div class="widget">
					...
					<div class="widget-header ps-titleHeader bordered-bottom">
						<form class="subform" method="post" action="/selfGroup/updateGroup" id="groupForm" onsubmit="return tjGrpForm()">
						...
						<div class="clearfix" style=" width:50%; margin:0 auto; padding:20px 0;">
							...
							<div class="pull-left" style="text-align: left;height: 40px">
									...
									class="colorpicker-default form-control pull-left" type="text"
									style="width: 300px;" value="${group.grpName}">
									<div class="ps-clear"></div>
							</div>
							<button type="submit" class="btn btn-info pull-left margin-left-10">修改</button>
						</div>
