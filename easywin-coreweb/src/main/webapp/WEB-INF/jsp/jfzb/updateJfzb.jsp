...
<script type="text/javascript">
	...
	$(function() {
		...
		$("body").on("click","#updateJfzb",function(){
			$(".subform").submit();
		})
	});
	
	function removeChoose(relateSelect,depId,ts){
		$(ts).remove();
...
<body>
	<form class="subform" method="post" action="/jfzb/updateJfzb">
		<tags:token></tags:token>
		<input type="hidden" name="id" value="${jfzb.id }" />
		<div class="container" style="padding: 0px 0px;width: 100%">
			<div class="row" style="margin: 0 0">
				<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
					<div class="widget" style="margin-top: 0px;">
						<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
							<span class="widget-caption themeprimary" style="font-size: 20px">编辑积分指标</span>
							<div class="widget-buttons ps-toolsBtn">
								<a href="javascript:void(0)" class="blue" id="updateJfzb">
									...
									<div class="tickets-container bg-white">
										<ul class="tickets-list">
											...
											<li class="ticket-item no-shadow ps-listline">
												...
												<div class="ticket-user pull-left ps-right-box" style="width: 500px">
				                                       <input type="text" name="leveTwo" style="width: 400px"
				                                        class="form-control pull-left" datatype="input,sn"  value="${jfzb.leveTwo }"
											...
											<li class="ticket-item no-shadow ps-listline" >
												...
												<div class="ticket-user pull-left ps-right-box" style="width: 500px">
				                                       <input type="text" id="jfBottom" name="jfBottom" style="width: 150px" value="${jfzb.jfBottom }"
				                                        ...
				                                        <input type="text" id="jfTop" name="jfTop" style="width: 150px" value="${jfzb.jfTop}"
												...
												<div style="float: left;width:50px;display: none">
													<select list="listJfzbDepScope" listkey="depId" listvalue="depName" id="listJfzbDepScope_select" name="listJfzbDepScope.dep" 
														...
														<c:choose>
															<c:when test="${not empty jfzb.listJfzbDepScope }">
																<c:forEach items="${jfzb.listJfzbDepScope}" var="scopeDep" varStatus="vs">
																	<option value="${scopeDep.depId }">${scopeDep.depName}</option>
																</c:forEach>
															</c:when>
														</c:choose>
													</select>
											...
											<li class="ticket-item no-shadow autoHeight no-padding" style="clear: both;" >
												...
												<div class="ticket-user pull-left ps-right-box" style="width: 400px;height: auto;">
											  		<textarea class="colorpicker-default form-control margin-top-10 margin-bottom-10" 
											  			style="height:150px;" 
											  			id="describe" name="describe" rows="" cols="">${jfzb.describe }</textarea>
												</div> 
	                                         ...
	                                         <li class="ticket-item no-shadow autoHeight no-padding" >
												...
												<div class="ticket-user pull-left ps-right-box" style="width: 400px;height: auto;">
											  		<textarea class="colorpicker-default form-control margin-top-10 margin-bottom-10" style="height:150px;" 
											  			id="remark" name=remark rows="" cols="">${jfzb.remark}</textarea>
												</div> 
												<div class="ps-clear"></div>              
	                                         </li>
										</ul>
