...
<title><%=SystemStrConstant.TITLE_NAME%></title>
	...
	function formSub(callBack){
		...
		if(checkstate){
		    ...
		    $(".subform").ajaxSubmit({
		        type:"post",
		        url:"/serialNum/addSerialNum?sid=${param.sid}&t="+Math.random(),
		        dataType: "json",
		        async:false,
...
<body>
<form class="subform" method="post" action="/serialNum/addSerialNum">
		...
		<div class="row" style="margin: 0 0">
			<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
            	<div class="widget" style="margin-top: 0px;" >
                	<div class="widget-header bordered-themeprimary bordered-bottom detailHead">
                        <span class="widget-caption themeprimary menu-topic ps-layerTitle" style="font-size: 20px">新增编号规则</span>
                             	...
                             	<div class="tickets-container bg-white">
									<ul class="tickets-list">
                                         ...
                                         <li class="ticket-item no-shadow ps-listline">
											...
											<div class="ticket-user pull-left ps-right-box">
											  	<div class="pull-left">
													<input id="startNum" defaultLen="52" name="startNum" nullmsg="请设置初始值！" 
													class="colorpicker-default form-control" type="text" value="" style="float: left">
												</div>
											</div>
                                         </li>
                                         <li class="ticket-item no-shadow ps-listline" style="height:165px;">
											...
											<div class="ticket-user pull-left ps-right-box padding-bottom-5" style="width:80%;">
												<textarea class="form-control" id="remark"
														...
														name="remark" >${task.taskRemark}</textarea>
											</div> 
										</li>
                                   	</ul>
                                </div>
