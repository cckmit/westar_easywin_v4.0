...
<body onload="resizeVoteH('allUser');">
<div class="panel">
	...
	<table class="table table-hover general-table">
		<thead>
			<tr>
			  ...
			  <th width="25%" valign="middle">隶属部门</th>
			  <th width="15%" valign="middle" style="text-align: center;">启用状态</th>
			</tr>
		</thead>
		<tbody>
		<c:choose>
	 ...
	 <tags:pageBar url="/userInfo/listPagedUserForDep"></tags:pageBar>
</div>
</div>	
