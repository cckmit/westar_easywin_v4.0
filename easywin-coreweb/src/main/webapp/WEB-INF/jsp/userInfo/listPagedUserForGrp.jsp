...
<div class="panel-body">
	<table class="table table-hover general-table">
		<thead>
			<tr>
			  <th width="10%" valign="middle" ><input type="checkbox" onclick="selectAll(this,'id')" /></th>
			  <th width="10%" valign="middle" >序号</th>
			  <th width="10%" valign="middle" >头像</th>
		 			...
		 			<tr>
		 				...
		 				<td valign="middle" >
							<img class="user-avatar"
								src="/downLoad/userImg/${user.comId}/${user.id}?sid=${param.sid}"
								title="${user.userName}" />
						</td>
