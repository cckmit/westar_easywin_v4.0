			...
			<div class="row">
				<div class="col-md-12 col-xs-12 ">
					<div class="widget">
						...
						<div>
                            <form action="/demand/listPagedDemandForConfirm" id="searchForm" class="subform">
                                ...
                                <div class="table-toolbar ps-margin margin-right-5">
                                        <div class="btn-group">
                                            <a class="btn btn-default dropdown-toggle btn-xs"  data-toggle="dropdown">
                                            	 发布人筛选<i class="fa fa-angle-down"></i>
                                            </a>
						...
						<div class="widget-body">
							...
							<tags:pageBar url="/demand/listPagedDemandForConfirm"></tags:pageBar>
						</div>
						</c:when>
					<c:otherwise>
