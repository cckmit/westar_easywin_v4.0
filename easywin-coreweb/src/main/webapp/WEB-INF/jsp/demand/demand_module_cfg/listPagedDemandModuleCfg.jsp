						...
						<div class="col-md-12 col-xs-12 ">
							<div class="widget">
								<div
									...
									<form action="/demandModuleCfg/listPagedDemandModuleCfg" id="searchForm">
										...
										<div class="ps-margin ps-search searchCond">
											<span class="input-icon"> 
												<input class="form-control ps-input moreSearch" id="templateName" name="templateName"
												value="${itemProgressTemplate.templateName}" type="text" placeholder="请输入关键字"> 
									...
									<div class="widget-buttons ps-widget-buttons">
										<button class="btn btn-info btn-primary btn-xs" type="button" opt-btn="addDemandModuleCfg">
											<i class="fa fa-plus"></i> 需求处理模板
										</button>
									</div>
								</div>
								<c:choose>
									<c:when test="${not empty lists}">
										<div class="widget-body">
											...
											<tags:pageBar url="/demandModuleCfg/listPagedDemandModuleCfg"></tags:pageBar>
										</div>
								</c:when>
								<c:otherwise>
									<div class="widget-body" style="height:550px; text-align:center;padding-top:170px">
										<section class="error-container text-center">
											...
											<div class="error-divider">
												...
												<a href="javascript:void(0);" opt-btn="addDemandModuleCfg"
													class="return-btn"><i class="fa fa-plus"></i>需求处理模板</a>
											</div>
										</section>
									</div>
								</c:otherwise>
