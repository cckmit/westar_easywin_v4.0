			...
			<div class="wechat-wrap">
				<div class="page-content submit-order">
					<div class="bg-white wechat-box">
						<div class="clearfix">
							<h4 class="no-margin">支付宝支付</h4>
						</div>
						<div class="wechat-bg">
							<c:choose>
								<c:when test="${tradeState  eq 1 }">
									<span><img src="/static/images/tj.png" /></span>交易付款成功！
								</c:when>
								<c:otherwise>
									<span><img src="/static/images/tj.png" /></span>${empty errorInfo?'交易付款失败！':errorInfo }
								</c:otherwise>
							</c:choose>
						</div>
