							...
							<div>
									<div class="btn-group pull-left searchCond">
										<div class="table-toolbar ps-margin">
											<div class="btn-group">
												<a class="btn btn-default dropdown-toggle btn-xs" data-toggle="dropdown" title="创建人筛选">
													创建人筛选
										...
										<div class="table-toolbar ps-margin">
											<div class="btn-group">
												<a class="btn btn-default dropdown-toggle btn-xs" data-toggle="dropdown" title="优先级筛选">
													优先级筛选
													<i class="fa fa-angle-down"></i>
												</a>
												<ul class="dropdown-menu dropdown-default">
													<li>
														<a href="javascript:void(0)" class="clearValue" relateElement="eventPriorityDegree">不限条件</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="eventPriorityDegree" dataValue="一级事件">一级事件</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="eventPriorityDegree" dataValue="二级事件">二级事件</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="eventPriorityDegree" dataValue="三级事件">三级事件</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="eventPriorityDegree" dataValue="四级事件">四级事件</a>
													</li>
												</ul>
											</div>
										</div>
										...
										<div class="table-toolbar ps-margin">
											<div class="btn-group">
												...
												<ul class="dropdown-menu dropdown-default">
													<li>
														<a href="javascript:void(0)" class="clearValue" relateElement="eventRepetitionMark">不限条件</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="eventRepetitionMark" dataValue="0">非重复事件</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="setValue" relateElement="eventRepetitionMark" dataValue="1">重复事件</a>
													</li>
												</ul>
											</div>
										</div>
										...
										<div class="table-toolbar ps-margin">
											<div class="btn-group cond" id="moreCondition_Div">
												<a class="btn btn-default dropdown-toggle btn-xs" onclick="displayMoreCond('moreCondition_Div')">
													<c:choose>
														<c:when test="${not empty param.startDate || not empty param.endDate}">
												...
												<div class="dropdown-menu dropdown-default padding-bottom-10" style="min-width: 330px;">
													<div class="ps-margin ps-search padding-left-10">
														...
														<input class="form-control dpd2 no-padding condDate" type="text" readonly="readonly" value="${param.startDate}" id="startDate" name="startDate" placeholder="开始时间"
															onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate: '#F{$dp.$D(\'endDate\',{d:-0});}'})" />
														<span>~</span>
														<input class="form-control dpd2 no-padding condDate" type="text" readonly="readonly" value="${param.endDate}" id="endDate" name="endDate" placeholder="结束时间"
								...
								<div style="float: left;width: 250px;display: none" id="formTempData">
									<input type="hidden" name="eventPriorityDegree" value="${param.eventPriorityDegree}">
									<input type="hidden" name="status" value="${param.status}">
									<input type="hidden" name="eventRepetitionMark" value="${param.eventRepetitionMark}">
