						...
						<div class="widget-header ps-titleHeader bordered-bottom bordered-themeprimary">
							<div>
								...
								<div style="float: left;width: 250px;display: none" id="formTempData">
									...
									<input type="hidden" name="modifyEndCode" value="${param.modifyEndCode}">
									<input type="hidden" name="illegalState" value="${param.illegalState}">
									<input type="hidden" name="scheduleState" value="${param.scheduleState}">
								...
								<div class="widget-buttons ps-widget-buttons">
									<a href="javascript:void(0);" addModifyPms>
								...
								<table class="table table-bordered " id="editabledatatable">
										<thead>
											<tr role="row">
												...
												<th style="text-align: center;font-weight:bold;padding: 0 0;width: 130px;">
													变更分类
												</th>
