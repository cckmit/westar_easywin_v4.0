...
<body>
	...
	<form class="subform" method="post" action="/crm/addCustomerType?sid=${param.sid}">
	...
	<div class="ws-message" style="padding:10px;">
		<ul>
			...
			<li class="ws-input-height">
				...
				<input type="text" id="typeOrder" datatype="n" name="typeOrder" style="width:160px;" value="${customerType.typeOrder}" />
			</li>
		</ul>
	</div>
	</form>
