...
$(function(){
	...
	function formSub(){
		...
		$(".subform").ajaxSubmit({
		        type:"post",
		        url:"/crm/batchCustomerHandOver?sid=${param.sid}&t="+Math.random(),
		        dataType: "json",
		        async: false,
		        beforeSubmit:function (a,f,o){
		        	...
		        	if(!toUser){
		    			...
		    			layer.tips("请选择客户接收人员",$("#showToUser"),{tips:1});
		    			return false;
...
<form class="subform" method="post">
	<input type="hidden" id="fromUser" name="fromUser" value="${userInfo.id}"/>
	<div class="container no-padding" style="width: 100%">	
		<div class="row" >
			<div class="col-lg-12 col-sm-12 col-xs-12" >
            	<div class="widget" style="margin-top: 0px;" >
                	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
                        <span class="widget-caption themeprimary" style="font-size: 20px">批量移交客户</span>
                     ...
                     <div class="widget-body margin-top-40" id="contentBody" style="height: 310px;overflow-y:auto;">
                             	...
                             	<div class="tickets-container bg-white" >
									<ul class="tickets-list">
											 	...
											 	<c:when test="${not empty listCustomer}">
											 		<c:forEach items="${listCustomer}" var="crmVo" varStatus="status">
											 		 <div class="alert-success margin-bottom-5" style="width: 350px">
														 <input type="hidden" name="customerIds" value="${crmVo.id}"/>
										...
										<div style="clear:both"></div>
                                         <li class="ticket-item no-shadow ps-listline" >
											...
											<div class="ticket-user pull-left ps-right-box" id="showToUser" style="min-width: 135px">
												<tags:userOne name="toUser"
													showValue="" value="" showName="onwerName"></tags:userOne>
										...
										<li class="ticket-item no-shadow autoHeight no-padding" style="border: 0">
											...
											<div class="ticket-user pull-left ps-right-box" style="width: 350px;height: auto;">
										  		<select class="populate" id="feedBackTypeId" name="feedBackTypeId" style="width:320px;" datatype="msg" nullmsg="请选择反馈类型">
