...
<body>
	...
	<form class="subform" method="post" action="/crm/addFeedBackType?sid=${param.sid}">
	<tags:token></tags:token>
	<div class="ws-message" style="padding:10px;">
		<ul>
			<li class="ws-input-height">
				<label style="width:55px;"><span>*</span>名称： </label>
				<input type="text" id="typeName" datatype="*" name="typeName" value="" style="width:160px;" />
			</li>
			<li class="ws-input-height">
				<label style="width:55px;"><span>*</span>排序： </label>
				<input type="text" id="typeOrder" datatype="n" name="typeOrder" style="width:160px;" value="${feedBackType.typeOrder}" />
			</li>
		</ul>
	</div>
	</form>
