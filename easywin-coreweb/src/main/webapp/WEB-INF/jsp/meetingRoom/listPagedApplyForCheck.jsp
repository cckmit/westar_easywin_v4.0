                	...
                	<div class="col-md-12 col-xs-12 ">
                    	<div class="widget">
                         	<div class="widget-header ps-titleHeader bordered-bottom bordered-themeprimary">
								...
								<form id="searchForm" action="/meetingRoom/listPagedApplyForCheck">
									...
									<div class="batchOpt" style="display: none">
										<div class="btn-group pull-left">
											<div class="table-toolbar ps-margin">
	                                        	<div class="btn-group">
													<a class="btn btn-default dropdown-toggle btn-xs" id="checkYes">
														审核通过
													</a>
	                                        	</div>
	                                    	</div>
											<div class="table-toolbar ps-margin">
	                                        	<div class="btn-group">
													<a class="btn btn-default dropdown-toggle btn-xs" id="checkNo">
														审核不通过
													</a>
	                                        	</div>
	                                    	</div>
                            ...
                            <div class="widget-body">
	                        	<form id="delForm" action="/meetingRoom/checkRoomApply" method="post">
										 		...
										 		<tr class="optTr">
	                                                <td class="optTd" style="height: 47px">
											 			<label class="optCheckBox" style="display: none;width: 20px">
										 					<input class="colored-blue" type="checkbox" name="ids" value="${obj.id}" state='${obj.state}'/>
													...
													<td valign="middle">
														<c:choose>
															<c:when test="${obj.state==0}">
																<a href="javascript:void(0)" onclick="checkApply(${obj.id},1)">批准</a>|
																<a href="javascript:void(0)" onclick="checkApply(${obj.id},2)">否决</a>
															</c:when>
                                   ...
                                   <tags:pageBar url="/meetingRoom/listPagedApplyForCheck"></tags:pageBar>
                                </div>
                            </div>
                        </div>             
                </div>
