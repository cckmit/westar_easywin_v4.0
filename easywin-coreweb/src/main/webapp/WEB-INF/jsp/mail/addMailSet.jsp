							...
							<div class="tabbable">
								<div class="tab-content tabs-flat no-margin">
									<div class="tab-pane active">
											...
											<div class="row">
												<div class="col-sm-7">
													<form action="/mailSet/addMailSet" method="post" id="mailSetForm">
	                                                    ...
	                                                    <div class="form-group clearfix">
	                                                        ...
	                                                        <div class="col-sm-10">
	                                                            <input type="text" class="form-control" placeholder="Email"id="email" name="email" onkeyup="FillSettings(this.value)">
	                                                        </div>
	                                                    </div>
	                                                    <div class="form-group clearfix">
	                                                    	<label for="inputPassword3" class="col-sm-2 control-label no-padding-right">服务器(SMTP)</label>
	                                                        <div class="col-md-7">
	                                                            <input type="text" name="serverHost" id="serverHost" placeholder="SMTP" class="form-control">
	                                                        </div>
	                                                    </div>
	                                                    <div class="form-group clearfix">
	                                                        <label for="inputPassword3" class="col-sm-2 control-label no-padding-right">端口(SMTP)</label>
	                                                        <div class="col-sm-10">
	                                                            <input type="text" style="width:200px;" name="serverPort" id="serverPort" class="form-control" placeholder="端口">
	                                                        </div>
	                                                    </div>
	                                                    <div class="form-group clearfix">
	                                                    	<label for="inputPassword3" class="col-sm-2 control-label no-padding-right">服务器(IMAP)</label>
	                                                        <div class="col-md-7">
	                                                            <input type="text" name="serverImapHost" id="serverImapHost" placeholder="POP" class="form-control">
	                                                        </div>
	                                                    </div>
	                                                    <div class="form-group clearfix">
	                                                        <label for="inputPassword3" class="col-sm-2 control-label no-padding-right">端口(IMAP)</label>
	                                                        <div class="col-sm-10">
	                                                            <input type="text" style="width:200px;" name="serverImapPort" id="serverImapPort" class="form-control" placeholder="端口">
	                                                        </div>
	                                                    </div>
	                                                    <div class="form-group clearfix">
	                                                        ...
	                                                        <div class="col-sm-10">
	                                                            <label class="optCheckBox" style="width: 20px">
												 					<input class="colored-blue" type="checkbox" id="smtpSSL" name="smtpSSL" value="1"/>
	                                                    ...
	                                                    <div class="form-group clearfix">
	                                                        ...
	                                                        <div class="col-sm-10">
	                                                            <input type="password" name="passwd" id="passwd" class="form-control" placeholder="邮箱授权码">
	                                                        </div>
	                                                    </div>
	                                                    <div class="form-group clearfix">
	                                                        <label for="inputPassword3" class="col-sm-2 control-label no-padding-right"></label>
	                                                        <div class="col-sm-10">
	                                                           <button  type="button" onclick="checkEmail(this,'${param.sid}')" class="btn btn-primary pull-right">保 存</button> 
	                                                        </div>
	                                                    </div>
	                                                </form>
												</div>
