	...
	<head>
		...
		function initSpFlowIdea(spStateparam,pDocumentParam,pWwindowParam){
			...
			if(spState ===0){
				...
				var params = {
						"busId":pWindow.EasyWin.modFlowConfig.busId,
						"busType":pWindow.EasyWin.modFlowConfig.busType,
						"actInstaceId":pWindow.EasyWin.modFlowConfig.actInstaceId,
						"sid":EasyWin.sid,
						"rnd":Math.random()
				}
                ...
                getSelfJSON("/modFlow/ajaxListHistorySpStep", params, function (data) {
                    if (data.status == 'y') {
