...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function returnStepConfig(){
			...
			if($(selectUsers).length==0){//没有审批人员
				if(resultStepType!='end'){//非办结步骤需要办理人员
					showNotification(2,"请选择下一步骤候选人");
					return null;
				}else{//办结步骤返回结果
					var result={"stepType":resultStepType,"stepId":resultStepId};
				
					var spIdea = $("#spIdea").val();
					if(pWindow.EasyWin.pageOpt == 'update'){//审批意见必填
						if(!spIdea){
							showNotification(2,"请填写审批意见！");
							return null;
						}
					}
				...
				$.each(selectUsers,function(index,selectUser){
					...
					if(csry.length==1){//告知人是办理人员
						showNotification(2,"告知人中需排除办理人员");
						csrySelectState = 0;
						return false;
					}
				})
		...
		function initUpFileHtml(){
			console.log(pWindow.EasyWin);
			if(pWindow.EasyWin.pageOpt == 'add'){
				$("#spIdeaDiv").remove();
				$("#fileDiv").show();
			}else{
				$("#spIdeaDiv").show();
		...
		<div class="widget-body no-shadow">
						<ul class="tickets-list">
							...
							<li class="clearfix ticket-item no-shadow autoHeight no-padding padding-top-5 padding-bottom-5">
                             ...
                             <li class="clearfix ticket-item no-shadow autoHeight no-padding padding-top-5 padding-bottom-5" id="rycsDiv">
						    	<div class="pull-left gray ps-left-text padding-top-10" style="text-align: right;">
						    		&nbsp;抄送：
						    	</div>
								<div class="ticket-user pull-left ps-right-box" style="height: auto;max-width: 380px" >
							...
							padding-bottom-5" id="xxtzDiv">
								...
								<div class="ticket-user pull-left ps-right-box margin-top-5" style="height: auto;max-width: 380px;min-height: 30px" >
									<label class="padding-left-5">
									 	<input type="checkbox" class="colored-blue" name="msgSendFlag" value="1"></input>
									 	<span class="text" style="color:inherit;">手机短信通知</span>
								    </label>
								</div> 
								<div class="ps-clear"></div>              
                             </li>
                             <li class="clearfix ticket-item no-shadow autoHeight no-padding padding-top-5 padding-bottom-5" id="spIdeaDiv">
							    <div class="pull-left gray ps-left-text" style="text-align: right;line-height: 60px;vertical-align: middle;">
                             ...
                             <li class="clearfix ticket-item no-shadow autoHeight no-padding padding-top-5 
								...
								<div class="ticket-user pull-left ps-right-box margin-top-5" style="height: auto;max-width: 380px;min-height: 30px" >
									<div style="clear:both;width: 300px" class="wu-example">
										...
										<div class="btns btn-sm padding-left-5">
