...
<body>
<div class="tit"><span>当前位置：系统管理>>组织机构维护</span></div>
<div class="block01">
  <div class="oper_btn">
  <span>
  ...
  <div id="container" style="width: 98%;margin-left: auto;margin-right: auto;display: none" align="center" > 
	<div id="left" style="width: 29%;float: left;border-right: #999999 1px dashed">
		<iframe id="leftFrame" name="leftFrame" src="/organization/treeOrganizationPage?rootId=${rootId }&sid=${param.sid }" style="width: 100%;height: 100%;" frameborder="0" scrolling="auto"></iframe>
	</div>
