...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#spStepFormControl").click(function(){
			formComponListForSelect("${spFlowModel.formKey}",0,0);//弹窗打开表单候选列表页面
		});
	})
$(document).ready(function(){
	$("#stepName").focus();
	$("#nextStepForSelectLi").css("height",(${fn:length(listNextStepForSelect)>3?fn:length(listNextStepForSelect):3}*40)+"px");//根据候选步骤个数设置候选步骤li高度
});
</script>
</head>
<body>
<form class="subform" method="post" action="/flowDesign/addFlowStep">
<tags:token></tags:token>
<input type="hidden" name="activityMenu" value="${activityMenu}"/>
<input type="hidden" name="pstepId" value="${pStepVo.id}"/>
			...
			<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
            	<div class="widget" style="margin-top: 0px;" >
                	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
                        <span class="widget-caption themeprimary" style="font-size: 20px">新建步骤</span>
									...
									<ul class="tickets-list">
                                         <li class="ticket-item no-shadow ps-listline">
											...
											<div class="ticket-user pull-left ps-right-box">
											   “<strong><span style="color:red;">${pStepVo.stepName}</span></strong>”
											</div>               
                                         </li>
                                         ...
                                         <li class="ticket-item no-shadow ps-listline" style="clear:both">
											...
											<div class="ticket-user pull-left ps-right-box">
											   <tags:radioDataDic type="executorWay" name="executorWay" style="ws-radio"
													value="directLeader"></tags:radioDataDic>
											</div>               
                                         </li>
                                         <li id="stepExecutorSelectLi" class="ticket-item no-shadow ps-listline" style="clear:both;display:none;">
										    <div class="pull-left gray ps-left-text">
										    	审批人
										    	<!-- <span style="color: red">*</span> -->
										    </div>
											   		...
											   		<c:forEach var="step" items="${listNextStepForSelect}">
													   	...
													   	<td>
													   		<label class="padding-left-5">
															 	...
															 	value="${step.id}" stepName="${step.stepName}"/>
                                         ...
                                         <li id="nextStepWaySelectLi" class="ticket-item no-shadow ps-listline" style="clear:both;display:none;">
										    <div class="pull-left gray ps-left-text">
										    	下步扭转方式
										    	<span style="color: red">*</span>
										    </div>
											<div class="ticket-user pull-left ps-right-box">
											   <tags:radioDataDic
													type="stepWay" name="nextStepWay" style="ws-radio"></tags:radioDataDic>
											</div>               
                                         </li>
                                         <li id="defaultStepForSelectLi" class="ticket-item no-shadow ps-listline" style="clear:both;display:none;">
										    <div class="pull-left gray ps-left-text">
										    	默认步骤
										    	<span style="color: red">*</span>
										    </div>
                                          ...
                                          <c:if test="${spFlowModel.flowModBusType eq '022'}">
	                                         <li class="ticket-item no-shadow ps-listline" style="clear:both">
												...
												<div class="ticket-user pull-left ps-right-box">
													<button id="spStepFormControl" class="btn btn-info btn-primary btn-xs" type="button">表单授权</button>
												</div>               
	                                         </li>
	                                         <li class="ticket-item no-shadow ps-listline" style="clear:both">
											    <div class="pull-left gray ps-left-text">
												...
												<div class="ticket-user pull-left ps-right-box">
													<label class="padding-top-5">
														<input class="checkbox-slider slider-icon colored-blue" type="checkbox" name="spCheckCfg" value="1" >
