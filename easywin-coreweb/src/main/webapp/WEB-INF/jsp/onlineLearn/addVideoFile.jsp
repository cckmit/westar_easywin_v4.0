 ...
 * 添加附件
 */
function addVideoFiles(callback){
	if($("#subState").val()==1){
		return;
	}
...
//附件上传的配置文件
	var WebUpfileConfig = {
        ...
        title:'rar,zip,doc,docx,xls,xlsx,ppt,pptx,txt,pdf,gif,jpg,jpeg,png,mp4,mov,mkv,mp3,m4a',
        extensions:'rar,zip,doc,docx,xls,xlsx,ppt,pptx,txt,pdf,gif,jpg,jpeg,png,mp4,mov,mkv,mp3,m4a',//3gp,avi,flv,mkv,mov,mp4,mpg,rmvb,swf,mid,wmv,mp3
        mimeTypes:'.rar,.zip,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt,.pdf,.gif,.jpg,.jpeg,.png,.mp4,.mov,.mkv,.mp3,.m4a',
        fileNumLimit:0
	}
</script>
</head>
<body style="background-color: #fff">
	...
	<form id="fileForm" class="subform" method="post">
		...
		<input type="hidden" name="moduleType" id="moduleType" value="023"/>
		<div id="fileDiv"></div>
				...
				<div class="col-lg-12 col-sm-12 col-xs-12" style="padding: 0px 0px">
					<div class="widget" style="margin-top: 0px;">
						<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
							<span class="widget-caption themeprimary padding-top-5" style="font-size: 20px">学习资料上传</span>
						...
						<div class="widget-body margin-top-40" id="contentBody" style="overflow: hidden;overflow-y:scroll;">
							<div class="widget radius-bordered">
								<div class="widget-header bg-bluegray no-shadow">
									<span class="widget-caption blue"><font color="red">*</font>资料描述</span>
								</div>
								<div class="widget-body no-shadow">
									<div class="tickets-container bg-white">
										<textarea id="fileDescribe" name="fileDescribe" style="height: 60px;color: #000;" class="form-control"></textarea>
									</div>
							...
							<div class="widget radius-bordered" style="clear:both">
								<div class="widget-header bg-bluegray no-shadow">
									<span class="widget-caption blue"><font color="red">*</font>资料</span>
								</div>
