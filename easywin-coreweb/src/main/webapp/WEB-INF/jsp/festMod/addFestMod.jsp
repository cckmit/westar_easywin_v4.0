...
<script type="text/javascript">
		...
		function saveFestMod(){
		    ...
		    $("#festModForm").ajaxSubmit({
		        type:"post",
		        url:"/festMod/addFestMod?sid=${param.sid}&t="+Math.random(),
		        dataType: "json",
		        async:false,
			...
			<div class="col-lg-12 col-sm-12 col-xs-12" >
            	<div class="widget" style="margin-top: 0px;">
	            	<div class="widget-header bordered-bottom bordered-themeprimary detailHead">
	                	<span class="widget-caption themeprimary" style="font-size: 20px">添加日期维护</span>
	                	<div class="widget-buttons ps-toolsBtn">
							<a href="javascript:void(0)" class="blue" id="saveFestModBtn">
									...
									<ul class="tickets-list">
										...
										<li class="ticket-item no-shadow ps-listline">
                                         ...
                                         <li class="ticket-item no-shadow ps-listline">
											...
											<div class="ticket-user pull-left ps-right-box">
												...
												name="clockDate" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate: '#F{$dp.$D(\'dayTimeE\',{d:-0});}'})" nullmsg="请选择日期" />
											</div>
										</li>
                                         <li class="ticket-item no-shadow ps-listline">
										    <div class="pull-left gray ps-left-text">
											...
											<div class="ticket-user pull-left ps-right-box">
												...
												name="clockDate" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate: '#F{$dp.$D(\'dayTimeS\',{d:+0});}'})" nullmsg="请选择日期" />
											</div>
										</li>
										...
										<li class="ticket-item no-shadow autoHeight no-padding" style="border-bottom: 0px">
											...
											<div class="ticket-user pull-left ps-right-box" style="width: 300px;height: auto;">
										  		...
										  		placeholder="日期描述……"  style="height:80px;width: 300px" id="describe" name="describe" rows="" cols=""></textarea>
											</div> 
