        ...
        */
        function drawLinks() {
            ...
            var appendItem = function(page_id, appendopts) {
                ...
                var li = $("<li></li>");
                if (page_id == current_page) {//当前页码
                    var lnk = $("<a>" + (appendopts.text) + "</a>");
                    if(appendopts.text!='<<' || appendopts.text!='>>'){
                    	li.removeAttr('class'); li.addClass("active");
                    }
                }
                else {
                    var lnk = $("<a>" + (appendopts.text) + "</a>")
                ...
                li.append(lnk);
                if((current_page==0 && appendopts.text=='<<') || 
                		(current_page== np - 1 && appendopts.text=='>>')){
                }else{
                	panel.append(li);
                }
