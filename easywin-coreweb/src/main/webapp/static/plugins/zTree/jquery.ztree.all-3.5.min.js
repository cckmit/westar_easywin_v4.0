...
(function(p) {
    ...
    m = {
        ...
        bindTree: function(b) {
            ...
            c = b.treeObj;
            b.view.txtSelectedEnable || c.bind("selectstart",
            function(a) {
...
(function(w) {
    ...
    x = {
        onHoverOverNode: function(b, a) {
            var c = n.getSetting(b.data.treeId),
            d = n.getRoot(c);
        ...
        onHoverOutNode: function(b) {
            var b = n.getSetting(b.data.treeId),
            a = n.getRoot(b);
            if (a.curHoverNode && !n.isSelectedNode(b, a.curHoverNode)) e.removeTreeDom(b, a.curHoverNode),
            a.curHoverNode = null
        },
        onMousedownNode: function(b, a) {
            function c(b) {
                ...
                if (B.dragFlag == 0) {
                    if (g.apply(f.callback.beforeDrag, [f.treeId, m], !0) == !1) return l(b),
                    !0;
                    ...
                    C.appendTo(M);
                    A = p("<span class='tmpzTreeMove_arrow'></span>", f);
                ...
                if (B.dragFlag == 1) {
                    ...
                    h = f;
                    o = n.getSettings();
                    for (var D in o) if (o[D].treeId && o[D].edit.enable && o[D].treeId != f.treeId && (b.target.id == o[D].treeId || w(b.target).parents("#" + o[D].treeId).length > 0)) J = !0,
                    h = o[D];
                    D = F.scrollTop();
                    k = F.scrollLeft();
                    i = h.treeObj.offset();
                    ...
                    c = b.clientY + D - i.top;
                    var q = h.treeObj.height() + i.top - b.clientY - D,
                    r = b.clientX + k - i.left,
                    x = h.treeObj.width() + i.left - b.clientX - k;
                    i = c < f.edit.drag.borderMax && c > f.edit.drag.borderMin;
                    var j = q < f.edit.drag.borderMax && q > f.edit.drag.borderMin,
                    K = r < f.edit.drag.borderMax && r > f.edit.drag.borderMin,
                    G = x < f.edit.drag.borderMax && x > f.edit.drag.borderMin,
                    q = c > f.edit.drag.borderMin && q > f.edit.drag.borderMin && r > f.edit.drag.borderMin && x > f.edit.drag.borderMin,
                    r = i && h.treeObj.scrollTop() <= 0,
                    x = j && h.treeObj.scrollTop() + h.treeObj.height() + 10 >= a,
                    P = K && h.treeObj.scrollLeft() <= 0,
                    Q = G && h.treeObj.scrollLeft() + h.treeObj.width() + 10 >= o;
                    if (b.target && g.isChildOrSelf(b.target, h.treeId)) {
                        ...
                        if (S && b.target && g.isChildOrSelf(b.target, E.id + d.id.A)) s = w(E),
                        u = E.id
                    }
                    o = m[0];
                    ...
                    if (s && s.attr("id") != h.treeId) {
                        ...
                        if (!o && !a && !G) {
                            if (s = null, u = "", v = d.move.TYPE_INNER, A.css({
                                display: "none"
                            ...
                            G = a ? G ? 0.75 : o ? 0.5 : 0 : -1;
                            b = (b.clientY + D - j) / c.height(); (K == 1 || b <= K && b >= -0.2) && o ? (a = 1 - A.width(), i = j - A.height() / 2, v = d.move.TYPE_PREV) : (G == 0 || b >= G && b <= 1.2) && a ? (a = 1 - A.width(), i = i == null || y.isParent && y.open ? j + c.height() - A.height() / 2 : i.offset().top - A.height() / 2, v = d.move.TYPE_NEXT) : (a = 5 - A.width(), i = j, v = d.move.TYPE_INNER);
                            A.css({
                                display: "block",
                                top: i + "px",
                                left: k + a + "px"
                            ...
                            if (y && y.isParent && v == d.move.TYPE_INNER && (b = !0, window.zTreeMoveTimer && window.zTreeMoveTargetNodeTId !== y.tId ? (clearTimeout(window.zTreeMoveTimer), window.zTreeMoveTargetNodeTId = null) : window.zTreeMoveTimer && window.zTreeMoveTargetNodeTId === y.tId && (b = !1), b)) window.zTreeMoveTimer = setTimeout(function() {
                    ...
                    } else if (v = d.move.TYPE_INNER, s && g.apply(h.edit.drag.inner, [h.treeId, m, null], !!h.edit.drag.inner) ? s.addClass(d.node.TMPTARGET_TREE) : s = null, A.css({
                        display: "none"
                    }), window.zTreeMoveTimer) clearTimeout(window.zTreeMoveTimer),
                    window.zTreeMoveTargetNodeTId = null;
                    T = u;
            ...
            function l(b) {
                ...
                if (B.dragFlag != 0) {
                    B.dragFlag = 0;
                    var a, i, j;
                    for (a = 0, i = m.length; a < i; a++) j = m[a],
                    j.isParent && B.dragNodeShowBefore[j.tId] && !j.open && (e.expandCollapseNode(f, j, !j.open), delete B.dragNodeShowBefore[j.tId]);
                    C && C.remove();
                    A && A.remove();
                    var q = b.ctrlKey && f.edit.drag.isMove && f.edit.drag.isCopy || !f.edit.drag.isMove && f.edit.drag.isCopy; ! q && s && u && m[0].parentTId && u == m[0].parentTId && v == d.move.TYPE_INNER && (s = null);
                    if (s) {
                        var r = u == null ? null: n.getNodeCache(h, u);
                        if (g.apply(f.callback.beforeDrop, [h.treeId, m, r, v, q], !0) == !1) e.selectNodes(x, m);
                        else {
                            var z = q ? g.clone(m) : m;
                            a = function() {
                                if (J) {
                                    if (!q) for (var a = 0,
                                    c = m.length; a < c; a++) e.removeNode(f, m[a]);
                                    if (v == d.move.TYPE_INNER) e.addNodes(h, r, z);
                                    else if (e.addNodes(h, r.getParentNode(), z), v == d.move.TYPE_PREV) for (a = 0, c = z.length; a < c; a++) e.moveNode(h, r, z[a], v, !1);
                                    else for (a = -1, c = z.length - 1; a < c; c--) e.moveNode(h, r, z[c], v, !1)
                                } else if (q && v == d.move.TYPE_INNER) e.addNodes(h, r, z);
                                else if (q && e.addNodes(h, r.getParentNode(), z), v != d.move.TYPE_NEXT) for (a = 0, c = z.length; a < c; a++) e.moveNode(h, r, z[a], v, !1);
                                else for (a = -1, c = z.length - 1; a < c; c--) e.moveNode(h, r, z[c], v, !1);
                                e.selectNodes(h, z);
                                p(z[0], f).focus().blur();
                    ...
                    } else e.selectNodes(x, m),
                    f.treeObj.trigger(d.event.DROP, [b, f.treeId, m, null, null, null])
                }
            }
            function k() {
                return ! 1
            }
            var i, j, f = n.getSetting(b.data.treeId),
            B = n.getRoot(f),
            t = n.getRoots();
            if (b.button == 2 || !f.edit.enable || !f.edit.drag.isCopy && !f.edit.drag.isMove) return ! 0;
            var q = b.target,
            r = n.getRoot(f).curSelectedList,
            m = [];
            ...
            var F = w(f.treeObj.get(0).ownerDocument),
            M = w(f.treeObj.get(0).ownerDocument.body),
            C,
            A,
            s,
            J = !1,
    ...
    w.extend(!0, w.fn.zTree._z, {
        tools: {
            ...
            showIfameMask: function(b, a) {
                for (var c = n.getRoot(b); c.dragMaskList.length > 0;) c.dragMaskList[0].remove(),
                c.dragMaskList.shift();
                if (a) for (var d = p("iframe", b), e = 0, i = d.length; e < i; e++) {
                    var j = d.get(e),
                    f = g.getAbs(j),
                    j = p("<div id='zTreeMask_" + e + "' class='zTreeMask' style='top:" + f[1] + "px; left:" + f[0] + "px; width:" + j.offsetWidth + "px; height:" + j.offsetHeight + "px;'></div>", b);
                    j.appendTo(p("body", b));
        ...
        view: {
            addEditBtn: function(b, a) {
                if (! (a.editNameFlag || p(a, d.id.EDIT, b).length > 0) && g.apply(b.edit.showRenameBtn, [b.treeId, a], b.edit.showRenameBtn)) {
                    var c = p(a, d.id.A, b),
                    l = "<span class='" + d.className.BUTTON + " edit' id='" + a.tId + d.id.EDIT + "' title='" + g.apply(b.edit.renameTitle, [b.treeId, a], b.edit.renameTitle) + "' treeNode" + d.id.EDIT + " style='display:none;'></span>";
                    c.append(l);
                    p(a, d.id.EDIT, b).bind("click",
                    function() {
            ...
            addRemoveBtn: function(b, a) {
                if (! (a.editNameFlag || p(a, d.id.REMOVE, b).length > 0) && g.apply(b.edit.showRemoveBtn, [b.treeId, a], b.edit.showRemoveBtn)) {
                    var c = p(a, d.id.A, b),
                    l = "<span class='fa  fa-times-circle fa-lg' id='" + a.tId + d.id.REMOVE + "' title='删除' treeNode" + d.id.REMOVE + " style='display:none;width:15px;height:15px'></span>";
                    c.append(l);
                    p(a, d.id.REMOVE, b).bind("click",
                    function() {
            ...
            addRemoveBtn: function(b, a) {
            	if (! (a.editNameFlag || p(a, d.id.REMOVE, b).length > 0) && g.apply(b.edit.showRemoveBtn, [b.treeId, a], b.edit.showRemoveBtn)) {
            		var c = p(a, d.id.A, b),
            		l = "<span class='" + d.className.BUTTON + " remove' id='" + a.tId + d.id.REMOVE + "' title='" + g.apply(b.edit.removeTitle, [b.treeId, a], b.edit.removeTitle) + "' treeNode" + d.id.REMOVE + " style='display:none;'></span>";
            		c.append(l);
            		p(a, d.id.REMOVE, b).bind("click",
            				function() {
            			if (!g.uCanDo(b) || g.apply(b.callback.beforeRemove, [b.treeId, a], !0) == !1) return ! 1;
            ...
            */
            addHoverDom: function(b, a) {
                if (n.getRoots().showHoverDom) a.isHover = !0,
                b.edit.enable && (e.addEditBtn(b, a), e.addRemoveBtn(b, a)),
            ...
            moveNode: function(b, a, c, l, k, i) {
                ...
                if (a != c && (!b.data.keep.leaf || !a || a.isParent || l != d.move.TYPE_INNER)) {
                    ...
                    if (l == d.move.TYPE_INNER) if (t) c.parentTId = null;
                    else {
                        if (!a.isParent) a.isParent = !0,
                        a.open = !!a.open,
                        e.setNodeLineIcos(b, a);
                        c.parentTId = a.tId
                    }
                    var q;
                    t ? q = t = b.treeObj: (!i && l == d.move.TYPE_INNER ? e.expandCollapseNode(b, a, !0, !1) : i || e.expandCollapseNode(b, a.getParentNode(), !0, !1), t = p(a, b), q = p(a, d.id.UL, b), t.get(0) && !q.get(0) && (q = [], e.makeUlHtml(b, a, q, ""), t.append(q.join(""))), q = p(a, d.id.UL, b));
                    var r = p(c, b);
                    ...
                    C = c.level;
                    if (c.isFirstNode) {
                        if (m = 0, g[f].length > 1) x = g[f][1],
                        x.isFirstNode = !0
                    } else if (c.isLastNode) m = g[f].length - 1,
                    x = g[f][m - 1],
                    x.isLastNode = !0;
                    else for (q = 0, r = g[f].length; q < r; q++) if (g[f][q].tId == c.tId) {
                        m = q;
                        break
                    }
                    m >= 0 && g[f].splice(m, 1);
                    ...
                    if (l == d.move.TYPE_INNER) {
                        a[f] || (a[f] = []);
                        if (a[f].length > 0) t = a[f][a[f].length - 1],
                        t.isLastNode = !1;
                        a[f].splice(a[f].length, 0, c);
                        c.isLastNode = !0;
                        c.isFirstNode = a[f].length == 1
                    } else a.isFirstNode && l == d.move.TYPE_PREV ? (j[f].splice(w, 0, c), t = a, t.isFirstNode = !1, c.parentTId = a.parentTId, c.isFirstNode = !0, c.isLastNode = !1) : a.isLastNode && l == d.move.TYPE_NEXT ? (j[f].splice(w + 1, 0, c), t = a, t.isLastNode = !1, c.parentTId = a.parentTId, c.isFirstNode = !1, c.isLastNode = !0) : (l == d.move.TYPE_PREV ? j[f].splice(w, 0, c) : j[f].splice(w + 1, 0, c), c.parentTId = a.parentTId, c.isFirstNode = !1, c.isLastNode = !1);
                    n.fixPIdKeyValue(b, c);
                    n.setSonNodeLevel(b, c.getParentNode(), c);
                    e.setNodeLineIcos(b, c);
                    e.repairNodeLevelClass(b, c, C); ! b.data.keep.parent && g[f].length < 1 ? (g.isParent = !1, g.open = !1, a = p(g, d.id.UL, b), l = p(g, d.id.SWITCH, b), f = p(g, d.id.ICON, b), e.replaceSwitchClass(g, l, d.folder.DOCU), e.replaceIcoClass(g, f, d.folder.DOCU), a.css("display", "none")) : x && e.setNodeLineIcos(b, x);
            ...
            selectNodes: function(b, a) {
                for (var c = 0,
                d = a.length; c < d; c++) e.selectNode(b, a[c], c > 0)
            }
        },
        event: {},
        data: {
            setSonNodeLevel: function(b, a, c) {
                if (c) {
                    ...
                    if (c[d]) for (var a = 0,
                    e = c[d].length; a < e; a++) c[d][a] && n.setSonNodeLevel(b, c, c[d][a])
                }
            }
        }
    });
    ...
    n.addInitProxy(function(b) {
        ...
        if (g.eqs(b.type, "mouseover")) {
            ...
            }])) k = g.getNodeMainDom(p).id,
            j = "hoverOverNode"
        } else if (g.eqs(b.type, "mouseout")) p = g.getMDom(c, e, [{
            tagName: "a",
            attrName: "treeNode" + d.id.A
        }]),
        p || (k = "remove", j = "hoverOutNode");
        else if (g.eqs(b.type, "mousedown") && (p = g.getMDom(c, a, [{
            tagName: "a",
            attrName: "treeNode" + d.id.A
        }]))) k = g.getNodeMainDom(p).id,
        j = "mousedownNode";
    ...
    n.addZTreeTools(function(b, a) {
        ...
        a.copyNode = function(a, l, k, i) {
            ...
            g.canAsync(b, a) ? e.asyncNode(b, a, i, l) : l()) : (e.addNodes(b, a.parentNode, [j], i), e.moveNode(b, a, j, k, !1, i));
            return j
        };
        ...
        a.moveNode = function(a, l, k, i) {
            ...
            if (!l) return l;
            if (a && !a.isParent && b.data.keep.leaf && k === d.move.TYPE_INNER) return null;
            else if (a && (l.parentTId == a.tId && k == d.move.TYPE_INNER || p(l, b).find("#" + a.tId).length > 0)) return null;
            else a || (a = null);
            g.canAsync(b, a) && k === d.move.TYPE_INNER ? e.asyncNode(b, a, i, j) : j();
            return l
        };
