...
function(e, t) {
    ...
    o = {
        ...
        use: function(e, t, n) {
            ...
            s = "layui_layer_" + e.replace(layui.cache.extend_dir, "").replace(/\.|\//g, "");
            return o.path ? (r && (l.rel = "stylesheet"), l[r ? "href": "src"] = /^http:\/\//.test(e) ? e: o.path + e, l.id = s, i("#" + s)[0] || a.appendChild(l),
            function c() { (r ? 1989 === parseInt(i("#" + s).css("width")) : o[n || s]) ?
                function() {
                    t && t();
                    try {
                        r || a.removeChild(l)
        ...
        ready: function(e) {
            return layui.addcss("pc/layer/layer.css", e, "skinlayercss"),
            this
        },
    ...
    o.style = function(e, t) {
        ...
        o !== a.type[1] && o !== a.type[2] || (n.css(t), o === a.type[2] && n.find("iframe").css({
