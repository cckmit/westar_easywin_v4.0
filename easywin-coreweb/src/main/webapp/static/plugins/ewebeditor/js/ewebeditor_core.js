...
var F = (function() {
    ...
    if (HI) {
        ...
        tx = true;
        GY = "firefox52p";
    } else if (s.fw('qqbrowser')) {
        tx = false;
        GY = "qqbrowser";
        if (GZ == 53) {
            var LG = s.match(/qqbrowser\/(\d+)\.(\d+)\.(\d+)/);
            if (LG) {
                var LK = parseInt(LG[1], 10);
                var Mn = parseInt(LG[2], 10);
                var Lu = parseInt(LG[3], 10);
                if ((LK == 9) && (Mn == 5) && (Lu < 9882)) {
                    tx = true;
                }
            }
        }
        ...
        tx = true;
        GY = "chrome";
        if ((s.fw('lbbrowser') && (GZ < 49)) || s.fw('metasr') || s.fw('2345explorer') || s.fw('maxthon') || s.fw('bidubrowser') || s.fw('ubrowser')) {
            tx = false;
        }
        if (tx) {
...
var am = (function() {
    ...
    var mv = function() {
        ...
        kP = "<html><head>" + "<link href='" + EWEB.cd + "/skin/" + config.Skin + "/menuarea.css' type='text/css' rel='stylesheet'>" + "</head>" + "<body scroll='no'>";
        if (F.as) {
    ...
    return {
        ...
        fJ: function(e, an) {
            ...
            case "marginbottom":
                ...
                for (var i = 0; i < Ja.length; i++) {
                    var Ll = Ja[i] ? Ja[i] : lang["DlgComDefault"];
                    if (v == Ja[i]) {
                        G += dY("", "Jz.Ky('" + an + "','" + Ja[i] + "')", 120, Ll);
                    } else {
                        G += dY("", "Jz.Ky('" + an + "','" + Ja[i] + "')", 119, Ll);
                    }
                }
                break;
            }
        ...
        rw: function(e) {
            ...
            if (mV("IMG")) {
                ...
                if (da == "mediaplayer6" || da == "mediaplayer7" || da == "realplayer" || da == "quicktime" || da == "flv" || da == "vlc" || da == "video" || da == "audio") {
...
var ci = (function() {
    ...
    var tJ = function(gV) {
        ...
        for (aV in hi) {
            ...
            if (aV == "TextIndent") {
                v = Jz.Kk("textindent");
            } else if (fl && aV.substring(0, 7) == "Justify") {
...
var bI = (function() {
    ...
    var Kp = function(EK) {
        ...
        for (var i = 0; i < Kh; i++) {
            ...
            for (var j = 0; j < Jg; j++) {
                ...
                for (var k = ba.sS; k <= ba.ru; k++) {
                    for (var m = ba.Ge; m <= ba.AF; m++) {
                        cz[m][k] = {
                            oW: i,
                            rq: j
                        };
    ...
    return {
        ...
        TableTemplate: function() {
            var Kx = EWEB.T.getElementsByTagName("TABLE");
            if (Kx.length <= 0) {
                alert(lang["MsgNoTable"]);
                return;
            }
            aK('tabletemplate.htm', true);
        },
        tK: function() {
            if (bI.bp()) {
        ...
        qt: function() {
            ...
            var hb = gp.Kc;
            var cQ = au.rowIndex;
            var CU = dk.insertRow(cQ);
            for (var i = 0; i < cz[cQ].length; i++) {
                var fH = cz[cQ][i].oW;
                var fL = cz[cQ][i].rq;
                var be = hb[fH][fL].KB;
                var lb = hb[fH][fL].Ge;
                ...
                if (lb == cQ) {
                    ...
                    Dy.style.cssText = be.style.cssText;
                } else if (lb < cQ) {
                    be.rowSpan = (kl - lb + 1) + 1;
                    var gJ = oc - kq + 1;
                    if (gJ > 1) {
                        i = i + (gJ - 1);
                    }
        ...
        rv: function() {
            ...
            var KP = (JS.AF - JS.Ge) + 1;
            var Jj = cz[cQ + KP][hy].oW;
            var Ku = cz[cQ + KP][hy].rq;
            var IV = hb[Jj][Ku];
            if (JS.sS == IV.sS && JS.ru == IV.ru) {
                var IS = IV.KB;
                aS.innerHTML = aS.innerHTML + IS.innerHTML;
                aS.rowSpan = aS.rowSpan + IS.rowSpan;
                dk.rows[Jj].deleteCell(Ku);
            }
            Et();
        },
        pI: function(mu) {
            ...
            if (Kr > 0) {
                ...
                for (var i = ni; i > eQ; i--) {
                    ...
                    for (k = 0; k < hy; k++) {
                        ...
                        var LD = cz[IP][k].rq;
                        var KS = hb[Mw][LD];
                        var Ld = KS.ru - KS.sS + 1;
                        if (cz[IP][k].oW == IP) {
                            LJ++;
                            k = k + Ld - 1;
                        }
                    }
                    var Dy = dk.rows[IP].insertCell(LJ);
                    Dy.innerHTML = "&nbsp;";
                    if (gJ > 1) {
                        Dy.colSpan = gJ;
                    }
                    Dy.style.cssText = aS.style.cssText;
                    aS.rowSpan = aS.rowSpan - 1;
                }
            }
            if (JN > 0) {
                for (var j = 0; j < cz[cQ].length; j++) {
                    if (j >= hy && j < (hy + gJ)) {
                        continue;
                    }
                    var fH = cz[cQ][j].oW;
                    var fL = cz[cQ][j].rq;
                    var Jl = hb[fH][fL];
                    var KU = Jl.ru - Jl.sS + 1;
                    var Lp = Jl.KB;
                    Lp.rowSpan = Lp.rowSpan + JN;
                    j = j + KU - 1;
                }
                for (var i = 1; i <= JN; i++) {
                    var CU = dk.insertRow(cQ + 1);
                ...
                for (var j = 0; j < cz[i].length; j++) {
                    ...
                    if (i == Jm) {
                        if (kl > i) {
                            ...
                            Ju = Ju + Lf;
                            Lf++;
                            var Dy = dk.rows[IK].insertCell(Ju);
                            Dy.innerHTML = "&nbsp;";
                            var Jr = (kl - lb + 1) - (Jm - lb + 1);
                            if (Jr > 1) {
                                Dy.rowSpan = Jr;
                            }
                            var II = (oc - kq + 1);
        ...
        sf: function() {
            ...
            for (var i = 0; i < cz.length; i++) {
                ...
                var oc = hT.ru;
                if (kq == hy) {
                    var Dy = dk.rows[i].insertCell(fL);
                    Dy.innerHTML = "&nbsp;";
                    var jQ = kl - lb + 1;
                    if (jQ > 1) {
                        Dy.rowSpan = jQ;
        ...
        sK: function() {
            ...
            for (var i = 0; i < cz.length; i++) {
                ...
                var oc = hT.ru;
                if (oc == hy) {
                    var Dy = dk.rows[i].insertCell(fL + 1);
                    Dy.innerHTML = "&nbsp;";
                    var jQ = kl - lb + 1;
                    if (jQ > 1) {
                        Dy.rowSpan = jQ;
        ...
        sq: function() {
            ...
            var KY = (JS.ru - JS.sS) + 1;
            var Jj = cz[cQ][hy + KY].oW;
            var Ku = cz[cQ][hy + KY].rq;
            var IV = hb[Jj][Ku];
            if (JS.Ge == IV.Ge && JS.AF == IV.AF) {
                var IS = IV.KB;
                aS.innerHTML = aS.innerHTML + IS.innerHTML;
                aS.colSpan = aS.colSpan + IS.colSpan;
                dk.rows[Jj].deleteCell(Ku);
            }
            Et();
        },
        rX: function() {
            ...
            var Jq = 0;
            for (var j = 0; j < cz[cQ].length; j++) {
                if (cz[cQ][j].oW == cQ && cz[cQ][j].rq == sH) {
                    Jq = j;
                    break;
                }
            }
        ...
        qY: function(mJ) {
            ...
            if (Jh > 0) {
                ...
                Jh--;
                for (var i = 1; i <= Jh; i++) {
                    var Dy = dk.rows[cQ].insertCell(sH + 1);
                    Dy.innerHTML = "&nbsp;";
                    if (jQ > 1) {
                        Dy.rowSpan = jQ;
                    }
...
var cW = (function() {
    ...
    return {
        ...
        MM: function(e) {
            ...
            var JV = R.gL(EWEB.aR);
            var mf = jq + cJ.offsetWidth - JV.X;
            nN = e.screenX - e.clientX;
            kA = mf - oy;
            if (e.clientX > kA) {
                df = true;
            }
            var mo = dM + cJ.offsetHeight - JV.Y;
...
var dN = (function() {
    ...
    var ur = function() {
        ...
        Jv = $("ImgResize_C_RM");
        IU = $("ImgResize_C_RB");
        R.az(document, 'mousedown', dN.PMD);
        nX = true;
    };
    var Kz = function() {
        Jw = false;
    ...
    var IL = function(v) {
        var JH = [ze, CW, Kd, Cn, Jb, Jf, IJ, Jx, IZ, Kq, Jv, IU];
        for (var i = 0; i < JH.length; i++) {
            JH[i].style.display = v;
        }
    };
    var JL = function(el, IR, Kw) {
        var w = IR - 2;
        var h = Kw - 2;
        var jq = el.clientLeft;
        var dM = el.clientTop;
        while (el) {
            jq += el.offsetLeft;
            dM += el.offsetTop;
        ...
        jq = jq - JV.X;
        dM = dM - JV.Y;
        jq = jq + $("eWebEditor").offsetLeft + $("eWebEditor_Layout").offsetLeft + jF(R.ce($("eWebEditor_EditareaTD"), "border-left-width")) + jF(R.ce($("eWebEditor"), "border-left-width"));
        dM = dM + $("eWebEditor").offsetTop + $("eWebEditor_Layout").offsetTop + $("eWebEditor_ToolarPTR").offsetHeight + jF(R.ce($("eWebEditor_EditareaTD"), "border-top-width")) + jF(R.ce($("eWebEditor"), "border-top-width"));
        Jb.style.left = jq + "px";
        Jb.style.top = dM + "px";
        Jx.style.left = (jq + parseInt(w / 2)) + "px";
        Jx.style.top = dM + "px";
        Kq.style.left = (jq + w) + "px";
        Kq.style.top = dM + "px";
        Jf.style.left = jq + "px";
        Jf.style.top = (dM + parseInt(h / 2)) + "px";
        Jv.style.left = (jq + w) + "px";
        Jv.style.top = (dM + parseInt(h / 2)) + "px";
        IJ.style.left = jq + "px";
        IJ.style.top = (dM + h) + "px";
        IZ.style.left = (jq + parseInt(w / 2)) + "px";
        IZ.style.top = (dM + h) + "px";
        IU.style.left = (jq + w) + "px";
        IU.style.top = (dM + h) + "px";
        ze.style.left = jq + "px";
        ze.style.top = dM + "px";
        ze.style.height = h + "px";
        CW.style.left = (jq + w + 1) + "px";
        CW.style.top = dM + "px";
    ...
    return {
        IX: function() {
            if (Jn()) {
                R.az(EWEB.T, 'keydown', dN.Jy);
                R.az(EWEB.T, 'mousedown', dN.Jy);
                R.az(EWEB.T, 'dblclick', dN.Jy);
                R.az(EWEB.T, 'click', dN.LC);
                R.az(EWEB.T, 'scroll', dN.Jy);
                R.az(EWEB.T, 'mouseup', dN.MU2);
                R.az(EWEB.T, 'mousemove', dN.MM2);
            }
        },
        Jy: function(e) {
            if (Jw) {
        ...
        MD2: function(e) {
            ...
            var el = e.srcElement || e.target;
            JQ = jF(R.ce(gu, "width"));
            Ka = jF(R.ce(gu, "height"));
            JJ = el.id.substr(12).toLowerCase();
        },
        MM2: function(e) {
            if (!fj) {
                return;
        ...
        PMD: function(e) {
            ...
            var el = e.srcElement || e.target;
            if (el != ze && el != CW && el != Kd && el != Cn && el != Jb && el != Jf && el != IJ && el != Jx && el != IZ && el != Kq && el != Jv && el != IU) {
                Kz();
            }
        }
    };
...
var FT = (function() {
    ...
    var LO = 0;
    var Ff = false;
    var Ih = (aA.Proto == "https") ? "20036": "20035";
    var Iv = function() {
    ...
    var JI = function(If) {
        return ("|importstatus|cancel|version|error|style|body|originalfiles|savedfiles|".indexOf("|" + If.toLowerCase() + "|") < 0);
    };
        ...
        if (F.qJ) {
            ...
            function(GU) {
                if (GU["XhrStatus"] == 200 && GU["Data"]["Status"] == "ok") {
                    if ("|capture|localupload|showeq|importword|pasteword|importexcelsheet|pasteexcel|importppt|pastefilelist|pasteimage|execasync|mfuupload|".indexOf("|" + If + "|") >= 0) {
                        HS["Act"] = "status";
    ...
    return {
        ...
        wQ: function(Iz, qD, zP, Ic, Ey) {
            ...
            if (Iz == "isinstalled") {
                if (LO == 0 && F.qJ) {
                    var LV = navigator.mimeTypes["application/x-ewebeditor-" + GF];
                    if (LV) {
                        if (FT.KI()) {
                            F.qJ = false;
                        }
            ...
            if (F.qJ) {
                ...
                case "importword":
                    ...
                    break;
                case "execasync":
                    this.kI.ExecAsync(qD[0], qD[1], qD[2], qD[3]);
                    break;
                case "pasteword":
                    var bu = qD[0];
...
var EWEB = {
    ...
    Focus: function() {
        ...
        if (F.as) {
            ...
            if (s.rangeCount < 1) {
                var My = dK;
                var KL = dK.firstChild;
                if (KL) {
                    if (KL.tagName == "P" || KL.tagName == "DIV") {
                        My = KL;
                    }
                }
                var r = this.T.createRange();
                r.selectNodeContents(My);
                r.collapse(true);
                s.addRange(r);
            }
            if (F.eo) {
    ...
    Init: function() {
        ...
        if (aA.ExtCSS) {
            this.ExtCSS = "<link href='" + uN(aA.ExtCSS) + "' type='text/css' rel='stylesheet'>";
        } else {
            this.ExtCSS = "";
        }
        if (aA.Skin) {
        ...
        this.LT = "?style=" + aA.StyleName + "&cusdir=" + aA.CusDir + "&sparams=" + config.SParams + "&skey=" + aA.SKey + "&h=" + aA.H;
        if (config.FSPath) {
            this.SendUrl = this.hW + this.cd + "/" + config.ServerExt + "/upload." + config.ServerExt + this.LT + "&ws=1&fs=" + config.FSPath;
            this.Nq = config.FSPath + config.ServerExt + "/upload." + config.ServerExt + this.LT + "&ws=" + this.hW + this.cd + "/";
            this.Nx = config.FSPath + config.ServerExt + "/browse." + config.ServerExt + this.LT + "&ws=" + this.hW + this.cd + "/";
        } else {
            this.SendUrl = this.hW + this.cd + "/" + config.ServerExt + "/upload." + config.ServerExt + this.LT;
            this.Nq = this.SendUrl;
            this.Nx = this.hW + this.cd + "/" + config.ServerExt + "/browse." + config.ServerExt + this.LT;
        }
...
function ts() {
    ...
    R.az(EWEB.db, 'keyup', _EditorTextarea_OnKeyUp);
    R.az(EWEB.db, 'paste', _EditorTextarea_OnPaste);
    R.az(EWEB.db, 'cut', _EditorTextarea_OnCut);
    if (F.as) {
        lT();
    } else {
...
function _EditorTextarea_OnKeyUp(e) {
    ...
    if (! (e.ctrlKey || e.altKey)) {
        if (R.KO([33, 34, 35, 36, 37, 38, 39, 40, 17, 18], bK) < 0) {
            Et();
        }
    }
    return true;
...
function sZ(e) {
    ...
    if (!bo && C.ai() == "Text") {
        if (! (e.ctrlKey && bA != "D" && bA != "V") && !e.metaKey && !e.shiftKey && !e.altKey) {
            var Ep = C.cI();
            if (Ep && Ep.className == "ewebeditor_template") {
                Ep.className = "";
            }
        }
    }
    ...
    if (el.tagName == "IMG") {
        ...
        if (KH == "math") {
            ...
            if (!da) {
                ...
                exec("flash");
            } else if (da == "mediaplayer6" || da == "mediaplayer7" || da == "realplayer" || da == "quicktime" || da == "flv" || da == "vlc" || da == "video" || da == "audio") {
                exec("media");
            }
        }
    }
...
function format(aN, fN) {
    ...
    EWEB.Focus();
    ci.eW();
    if (R.KO(["selectall", "unselect"], aN) < 0) {
        Et();
    }
};
function pk() {
...
function pG(V) {
    ...
    case 'VIEW':
        if (config.AreaCssMode != '1') {
            dS += '<link href="' + EWEB.cd + '/skin/' + config.Skin + '/editarea.zh-cn.css" type="text/css" rel="stylesheet">';
        }
        dS += EWEB.ExtCSS;
        break;
    }
...
function wr() {
    ...
    bC += "<div style='width:1px;height:1px;position:absolute;left:-10000'>";
    bC += "<input type='text' id='D_ContentEdit' value=''>";
    bC += "<input type='text' id='D_CurrMode' value=''>";
    bC += "<input type='text' id='D_ContentLoad' value=''>";
    bC += "<input type='text' id='D_ContentFlag' value='0'>";
    bC += "<input type='text' id='D_PaginationTitle' value=''>";
    bC += "</div>";
    bC += "<div style='position:absolute;display:none'>";
    bC += "<form id='eWebEditor_UploadForm' action='" + EWEB.Nq + "&action=remote&type=remote' method='post' target='eWebEditor_UploadTarget'>";
...
aE.vb = function(V) {
    function _Replace(m, aH) {
        function gm(m, bv) {
            if (['flash', 'flv', 'mediaplayer6', 'mediaplayer7', 'realplayer', 'quicktime', 'vlc', 'video', 'audio', 'unknownobject'].IndexOf(aH) >= 0) {
                var ak = aE.pr(m, 'img');
                if (ak != '') {
                    ak = ' style=' + ak;
                }
                ...
                eu = aE.ov(eu, "video", ak);
                eu = aE.ov(eu, "audio", ak);
                eu = aE.sv(eu, ["object", "embed", "video", "audio"], [["width", eh], ["height", ff], ["align", fQ], ["vspace", jB], ["hspace", gq]]);
                return eu;
            } else {
...
aE.LZ = function(V) {
    function _Replace(m) {
        return aE.ct('video', m, 'video');
    };
    return V.replace(/<video[\s\S]*?<\/video>/gi, _Replace);
};
aE.KK = function(V) {
    function _Replace(m) {
        return aE.ct('audio', m, 'audio');
    };
    return V.replace(/<audio[\s\S]*?<\/audio>/gi, _Replace);
};
...
var hZ = {
    Execute: function(aN) {
        if (C.ai() == "Control") {
            var bg = C.ax();
            if (aN == "justifyfull") {
                bg.removeAttribute("align");
            } else {
                bg.align = aN.substr(7);
            }
            var p = R.Mv(bg, ["P", "DIV", "TD", "TH"]);
            var p1, p2;
            if (p) {
                if (R.KO(["TD", "TH"], p.tagName) >= 0) {
                    p2 = p;
                } else {
                    p1 = p;
                }
            ...
            if (p2) {
                var c1 = R.Mc(bg, p2);
                var IQ = EWEB.T.createElement("p");
                c1.parentNode.insertBefore(IQ, c1);
                IQ.appendChild(c1.parentNode.removeChild(c1));
                p1 = IQ;
            }
            if (p1) {
                ...
                if (aN == "justifyfull") {
                    ...
                    p1.style.textAlign = aN.substr(7);
...
kQ.Execute = function() {
    ...
    if(parent.EasyWin && parent.EasyWin.ewebMaxMin == 'self'){
    	var id = bQ.getAttribute("id");
    	var src = bQ.getAttribute("src");
    	parent.ewebMaxMin(id,src);
    	return;
    }
    var bd;
    if (!this.hM) {
...
function LH() {
    var Mp = config.WordEqVersion;
    if (Mp == "") {
        alert("Not Installed!");
        FT.jT(false);
        return;
    }
    FT.wQ("getinfo", ["wordeqinstall", Mp, ""],
    function(hT) {
        if (!hT["Ret"]) {
            FT.jT(false);
            return;
...
function Lc() {
    ...
    if (C.ai() == "Control") {
        var bg = C.ax();
        if (bg.tagName == "IMG" && bg.getAttribute("_tag", 2) == "wordeq") {
            Iz = "edit";
            LP = bg.getAttribute("_eqcode", 2);
            if (!LP) {
                LP = ""
            }
            LX = bg.getAttribute("_eqtype", 2);
            if (!LX) {
                LX = ""
            }
        } else {
    ...
    var bu = "wordeq:1;width:880;height:500;action:" + Iz + ";pointsize:" + bn + ";eqtype:" + LX + ";ver:" + config.WordEqVersion + ";";
    FT.wQ("showeq", [LP, bu],
    function(hT) {
        if (hT["Error"] == "cancel") {
            FT.jT(false);
...
R.kx = function(kG, Cr, eE) {
    if (kG.hasChildNodes()) {
        for (var i = 0; i < kG.childNodes.length; i++) {
            var bz = kG.childNodes[i];
            if (bz.nodeType == 1) {
                if (!eE || (eE && bz.tagName && this.KO(eE, bz.tagName) >= 0)) {
                    this.cP(bz, Cr);
                }
                this.kx(bz, Cr, eE);
            }
...
R.Mv = function(bz, Jo) {
    while (bz && bz.tagName && bz.tagName != "BODY" && bz.getAttribute("id") != "eWebEditor_FixWidth_DIV") {
        var mL = bz.tagName.toUpperCase();
        if (R.KO(Jo, mL) >= 0) {
            return bz;
        }
        bz = bz.parentNode;
...
R.Lq = function() {
    return (config.FixWidth ? EWEB.T.getElementById("eWebEditor_FixWidth_DIV") : EWEB.T.body);
};
R.Lg = function(bz) {
    if (bz && bz.tagName && ((bz.tagName == "BODY") || ((bz.tagName == "DIV") && (bz.getAttribute("id") == "eWebEditor_FixWidth_DIV")))) {
        return true;
    } else {
        return false;
    }
...
C.Mk = function() {
    var p = null;
    if (F.as) {
        var Bd = EWEB.T.selection;
        if (Bd && Bd.type && Bd.type == "None") {
            var nr = Bd.createRange();
            if (nr) {
                var Mj = nr.parentElement();
                var bz = R.Mv(Mj, ["P", "DIV", "TD", "TH", "TABLE"]);
                if (bz) {
                    var aH = bz.tagName.toUpperCase();
                    if (R.KO(["P", "DIV"], aH) >= 0) {
                        if ((config.FixWidth) && (aH == "DIV") && (bz.getAttribute("id") == "eWebEditor_FixWidth_DIV")) {} else {
                            var KG = EWEB.T.body.createTextRange();
                            KG.moveToElementText(bz);
                            if (KG.collapse) {
                                KG.collapse(true);
                                if (nr.isEqual(KG)) {
                                    p = bz;
        ...
        if (Bd && Bd.rangeCount == 1) {
            ...
            if (nr.collapsed && nr.startOffset == 0) {
                var bz = nr.startContainer;
                while (bz) {
                    if (bz.nodeType == 1) {
                        var aH = bz.tagName.toUpperCase();
                        if (R.KO(["P", "DIV"], aH) >= 0) {
                            if ((config.FixWidth) && (aH == "DIV") && (bz.getAttribute("id") == "eWebEditor_FixWidth_DIV")) {
                                bz = null;
                            } else {
                                p = bz;
                                bz = null;
                            }
                        } else if (R.KO(["TABLE", "TD", "TH", "BODY"], aH) >= 0) {
                            bz = null;
                        } else if (bz.previousSibling) {
                            bz = null;
                        } else {
                            bz = bz.parentNode;
                        }
    ...
    if (F.as) {
        ...
        default:
            if (F.Cf || F.GD) {
                ...
                var Kl = this.bG().createRange();
                var el = Kl.parentElement();
                var Mf = EWEB.T.body.createTextRange();
                Mf.moveToElementText(el);
                if (Kl.text.length > Mf.text.length) {
...
C.ww = function(el) {
    if (F.as) {
        ...
        var iP = Bd.getRangeAt(0);
        var gF = EWEB.T.createRange();
...
C.dh = function(eE, nz) {
    ...
    var LN = (bd) ? bd: EWEB.T.body;
    for (var i = 0; i < eE.length; i++) {
        var a = LN.getElementsByTagName(eE[i]);
...
function getSelectedHTML() {
    ...
    case "EDIT":
        var V = "";
        if (window.getSelection) {
            var Ml = EWEB.aR.getSelection().rangeCount;
            for (var i = 0; i < Ml; i++) {
                var r = EWEB.aR.getSelection().getRangeAt(i);
...
var Jz = (function() {
    ...
    return {
        ...
        Ky: function(aV, bv) {
            ...
            for (var i = 0; i < a.length; i++) {
                if (aV == "textindent") {
                    a[i].style.textIndent = bv;
                } else if (aV == "lineheight") {
                    a[i].style.lineHeight = bv;
                    R.kx(a[i], {
                        "lineHeight": ""
                    },
                    ["SPAN"]);
                } else if (aV == "margintop") {
                    a[i].style.marginTop = bv;
                } else if (aV == "marginbottom") {
                    a[i].style.marginBottom = bv;
                }
            }
            if (aV == "textindent") {
                EWEB.Focus();
