...
dtmlXMLLoaderObject.prototype.loadXML = function(e, t, i, s) {
    ...
    s ? (this.xmlDoc.setRequestHeader("User-Agent", "dhtmlxRPC v0.1 (" + navigator.userAgent + ")"), this.xmlDoc.setRequestHeader("Content-type", "text/xml")) : t && this.xmlDoc.setRequestHeader("Content-type", "application/x-www-form-urlencoded"),
...
dtmlXMLLoaderObject.prototype.xmlNodeToJSON = function(e) {
    for (var t = {},
    i = 0; i < e.attributes.length; i++) t[e.attributes[i].name] = e.attributes[i].value;
...
dhtmlDragAndDropObject.prototype.calculateFramePosition = function(e) {
    if (window.name) {
        for (var t = parent.frames[window.name].frameElement.offsetParent, i = 0, s = 0; t;) i += t.offsetLeft,
        s += t.offsetTop,
        t = t.offsetParent;
...
dtmlXMLLoaderObject.prototype.doXPath = function(e, t, i, s) {
    ...
    t || dhtmlxError.throwError("LoadXML", "Incorrect XML", [t || this.xmlDoc, this.mainObject]),
    -1 != t.nodeName.indexOf("document") ? a = t: (a = t, t = t.ownerDocument);
    ...
    for (var o = d.iterateNext(); o;) r[r.length] = o,
    o = d.iterateNext();
    return r
},
...
dtmlXMLLoaderObject.prototype._getAllNamedChilds = function(e, t) {
    ...
    for (var s = 0; s < e.length; s++) for (var a = 0; a < e[s].childNodes.length; a++) _isKHTML ? e[s].childNodes[a].tagName && e[s].childNodes[a].tagName.toUpperCase() == t && (i[i.length] = e[s].childNodes[a]) : e[s].childNodes[a].tagName == t && (i[i.length] = e[s].childNodes[a]);
    return i
},
...
dtmlXMLLoaderObject.prototype.doXSLTransToObject = function(e, t) {
    ...
    } else this.XSLProcessor || (this.XSLProcessor = new XSLTProcessor, this.XSLProcessor.importStylesheet(e)),
...
dhtmlxEventable = function(obj) {
    ...
    obj.eventCatcher = function(obj) {
        ...
        z = function() {
            for (var e = !0,
            t = 0; t < dhx_catch.length; t++) if (dhx_catch[t]) {
...
function() {
    ...
    function t(t) {
        if (c) {
            ...
            return dhtmlx.message.keyboard && ((13 == i || 32 == i) && e(c, !0), 27 == i && e(c, !1)),
    ...
    function n(t, i, a) {
        ...
        if (t.buttons) for (var l = 0; l < t.buttons.length; l++) r += s(t.buttons[l], l);
...
dataProcessor.prototype = {
    setTransactionMode: function(e, t) {
        this._tMode = e,
        this._tSend = t,
        "REST" == e && (this._tSend = !1, this._endnm = !0)
    },
    escape: function(e) {
    ...
    setUpdated: function(e, t, i) {
        if (!this._silent_mode) {
            ...
            a && "updated" == i && (i = a),
            t ? (this.set_invalid(e, !1), this.updatedRows[s] = e, this.obj.setUserData(e, this.action_param, i), this._in_progress[e] && (this._in_progress[e] = "wait")) : this.is_invalid(e) || (this.updatedRows.splice(s, 1), this.obj.setUserData(e, this.action_param, "")),
    ...
    _sendData: function(e, t) {
        if (e) {
            ...
            var i = new dtmlXMLLoaderObject(function(i, s, a, n, r) {
                var d = [];
                if (t) d.push(t);
                else if (e) for (var o in e) d.push(o);
    ...
    sendAllData: function() {
        if (this.updatedRows.length) {
            this.messages = [];
            for (var e = !0,
            t = 0; t < this.updatedRows.length; t++) e &= this.checkBeforeUpdate(this.updatedRows[t]);
    ...
    _getAllData: function(e) {
        for (var t = {},
        i = !1,
        s = 0; s < this.updatedRows.length; s++) {
    ...
    afterUpdateCallback: function(e, t, i, s) {
        ...
        "wait" != this._in_progress[a] ? (n && this.obj.setUserData(e, this.action_param, ""), delete this._in_progress[a]) : (delete this._in_progress[a], this.setUpdated(t, !0, this.obj.getUserData(e, this.action_param))),
    ...
    afterUpdate: function(e, t, i) {
        ...
        if (t.getXMLTopNode("data"), !t.xmlDoc.responseXML) return this.obj && this.obj.callEvent && this.obj.callEvent("onSaveError", [i, t.xmlDoc]),
        this.cleanUpdate(i);
...
Scheduler.getSchedulerInstance = function() {
    ...
    scheduler.set_xy = function(e, t, i, s, a) {
        ...
        arguments.length > 3 && (e.style.left = s + "px", e.style.top = a + "px")
    },
    ...
    scheduler._click = {
        ...
        buttons: {
            "delete": function(e) {
                ...
                scheduler._dhtmlx_confirm(t, scheduler.locale.labels.title_confirm_deleting,
                function() {
    ...
    scheduler.addEventNow = function(e, t, i) {
        ...
        if (!t) {
            ...
            r > n.getHours() && (n.setHours(r), e = n.valueOf()),
            t = e.valueOf() + a
        }
        var d = new Date(t);
    ...
    scheduler._get_column_index = function(e) {
        ...
        if (this._cols) {
            for (var i = 0,
            s = 0; s < this._cols.length && !i; s++) i = this._cols[s];
    ...
    scheduler._mouse_coords = function(e) {
        ...
        if (a) t = a.call(this, t);
            ...
            "move" == this._drag_mode && scheduler._ignores_detected && scheduler.config.preserve_length && (t._ignores = !0, this._drag_event._event_length || (this._drag_event._event_length = this._get_real_event_length(this._drag_event.start_date, this._drag_event.end_date, {
                x_step: 1,
                x_unit: "day"
            }))),
            t.x = 0
    ...
    scheduler._close_not_saved = function() {
        if ((new Date).valueOf() - (scheduler._new_event || 0) > 500 && scheduler._edit_id) {
            ...
            scheduler._dhtmlx_confirm(e, scheduler.locale.labels.title_confirm_closing,
            function() {
    ...
    scheduler._on_mouse_move = function(e) {
        if (this._drag_mode) {
            ...
            if (this._is_pos_changed(this._drag_pos, t)) {
                ...
                "move" == this._drag_mode) i = this._min_date.valueOf() + 6e4 * (t.y * this.config.time_step + 24 * t.x * 60 - (scheduler._move_pos_shift || 0)),
                !t.custom && this._table_view && (i += 1e3 * this.date.time_part(o.start_date)),
                i = this._correct_shift(i),
                t._ignores && this.config.preserve_length && this._table_view ? (i = scheduler._correct_drag_start_date(i), s = scheduler._correct_drag_end_date(i, this._drag_event._event_length)) : s = o.end_date.valueOf() - (o.start_date.valueOf() - i);
                else {
                ...
                if ("move" == this._drag_mode && scheduler.config.limit_drag_out && ( + f < +scheduler._min_date || +s > +scheduler._max_date)) {
                    if ( + o.start_date < +scheduler._min_date || +o.end_date > +scheduler._max_date) f = new Date(o.start_date),
                    s = new Date(o.end_date);
                    else {
                        var v = s - f; + f < +scheduler._min_date ? (f = new Date(scheduler._min_date), t._ignores && this.config.preserve_length && this._table_view ? (f = new Date(scheduler._correct_drag_start_date(f)), d._start_correction && (f = new Date(f.valueOf() + d._start_correction)), s = new Date(1 * f + this._get_fictional_event_length(f, this._drag_event._event_length, d))) : s = new Date( + f + v)) : (s = new Date(scheduler._max_date), t._ignores && this.config.preserve_length && this._table_view ? (d._end_correction && (s = new Date(s.valueOf() - d._end_correction)), s = new Date(1 * s - this._get_fictional_event_length(s, 0, d, !0)), f = new Date(1 * s - this._get_fictional_event_length(s, this._drag_event._event_length, d, !0)), this._ignores_detected && (f = scheduler.date.add(f, d.x_step, d.x_unit), s = new Date(1 * s - this._get_fictional_event_length(s, 0, d, !0)), s = scheduler.date.add(s, d.x_step, d.x_unit))) : f = new Date( + s - v))
                    }
                    var g = new Date(s - 1)
                }
                ...
                if (this._table_view || g.getDate() == f.getDate() && g.getHours() < this.config.last_hour || scheduler._allow_dnd) if (o.start_date = f, o.end_date = new Date(s), this.config.update_render) {
                ...
                this._table_view && this.for_rendered(this._drag_id,
                function(e) {
        ...
        if (!e || 2 != e.button || !scheduler.config.touch) {
            if (this._drag_mode && this._drag_id) {
                ...
                if (s && (this._drag_event._dhx_changed || !this._drag_event.start_date || a.start_date.valueOf() != this._drag_event.start_date.valueOf() || a.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                    ...
                    if (this.callEvent("onBeforeEventChanged", [a, e, n, this._drag_event])) if (this._drag_id = this._drag_mode = null, n && this.config.edit_on_create) {
                        if (this.unselect(), this._new_event = new Date, this._table_view || this.config.details_on_create || !this.config.select) return scheduler.callEvent("onDragEnd", [t, i, e]),
                        this.showLightbox(t);
                        this._drag_pos = !0,
                        this._select_id = this._edit_id = t
                    } else this._new_event || this.callEvent(n ? "onEventAdded": "onEventChanged", [t, this.getEvent(t)]);
                    else n ? this.deleteEvent(a.id, !0) : (this._drag_event._dhx_changed = !1, this._clear_temporary_properties(a, this._drag_event), scheduler._lame_copy(a, this._drag_event), this.updateEvent(a.id))
                }
                this._drag_pos && (this._drag_pos.has_moved || this._drag_pos === !0) && (this._drag_id = this._drag_mode = null, this.render_view_data()),
    ...
    scheduler.updateView = function(e, t) {
        ...
        var a = "dhx_multi_day";
        this._els[a] && (this._els[a][0].parentNode.removeChild(this._els[a][0]), this._els[a] = null),
        this._mode = t,
        this._date = e,
    ...
    scheduler._render_x_header = function(e, t, i, s, a) {
        ...
        "month" == this._mode && 0 === e && this.config.left_border && (n.className += " dhx_scale_bar_border", t += 1),
    ...
    scheduler._calc_scale_sizes = function(e, t, i) {
        ...
        r = 0; a > r; r++) this._ignores[r] ? (this._cols[r] = 0, n++) : this._cols[r] = Math.floor(s / (n - r)),
        s -= this._cols[r],
    ...
    scheduler._reset_hours_scale = function(e, t, i) {
        ...
        for (var a = new Date(1980, 1, 1, this.config.first_hour, 0, 0), n = 1 * this.config.first_hour; n < this.config.last_hour; n++) {
            ...
            this.config.left_border && (d -= 1, r.className += " dhx_scale_hour_border"),
            r.style.width = d + "px",
    ...
    scheduler._process_ignores = function(e, t, i, s, a) {
        ...
        if (n) for (var r = new Date(e), d = 0; t > d; d++) n(r) && (this._ignores_detected += 1, this._ignores[d] = !0, a && t++),
    ...
    scheduler._render_month_scale = function(e, t, i) {
        ...
        for (var g = [], l = 0; d > l; l++) {
            ...
            for (var v = Math.max(s(l) - scheduler.xy.month_head_height, 0), m = 0; 7 > m; m++) {
                ...
                y = "dhx_month_head";
                if (0 === m && this.config.left_border && (b += " dhx_month_body_border", y += " dhx_month_head_border"), this._ignores_detected && this._ignores[m]) p.appendChild(document.createElement("div")),
    ...
    scheduler.getLabel = function(e, t) {
        for (var i = this.config.lightbox.sections,
        s = 0; s < i.length; s++) if (i[s].map_to == e) for (var a = i[s].options, n = 0; n < a.length; n++) if (a[n].key == t) return a[n].label;
        return ""
    },
    ...
    scheduler._lame_clone = function(e, t) {
        ...
        if (e && "object" == typeof e) {
            for (a = {},
            s = [Array, Date, Number, String, Boolean], i = 0; i < s.length; i++) e instanceof s[i] && (a = i ? new s[i](e) : new s[i]);
            t.push(e, a);
    ...
    scheduler.date = {
        init: function() {
            for (var e = scheduler.locale.date.month_short,
            t = scheduler.locale.date.month_short_hash = {},
            i = 0; i < e.length; i++) t[e[i]] = i;
            for (var e = scheduler.locale.date.month_full,
            t = scheduler.locale.date.month_full_hash = {},
            i = 0; i < e.length; i++) t[e[i]] = i
        },
        ...
        str_to_date: function(e, t) {
            ...
            s = e.match(/%[a-zA-Z]/g), a = 0; a < s.length; a++) switch (s[a]) {
            case "%j":
            case "%d":
                i += "set[2]=temp[" + a + "]||1;";
                break;
    ...
    scheduler.addEvent = function(e, t, i, s, a) {
        ...
        n.start_date = e, n.end_date = t, n.text = i, n.id = s),
    ...
    scheduler.deleteEvent = function(e, t) {
        var i = this._events[e]; (t || this.callEvent("onBeforeEventDelete", [e, i]) && this.callEvent("onConfirmedBeforeEventDelete", [e, i])) && (i && (this._select_id = null, delete this._events[e], this.event_updated(i)), this.callEvent("onEventDeleted", [e, i]))
    },
    ...
    function() {
        ...
        s = 0; s < e.length; s += 2) scheduler["getEvent" + e[s + 1]] = t(e[s]),
    ...
    scheduler.render_view_data = function(e, t) {
        ...
        for (var i = 0,
        s = e.length; s > i; i++) this._recalculate_timed(e[i]);
    ...
    scheduler._render_month_link = function(e) {
        for (var t = this._rendered_location,
        i = this._lame_clone(e), s = e._sday; s < e._eday; s++) {
            i._sday = s,
            i._eday = s + 1;
    ...
    scheduler.render_data = function(e, t) {
        ...
        for (var i = 0; i < e.length; i++) if (this._table_view) if ("month" != scheduler._mode) this.render_event_bar(e[i]);
        else {
    ...
    scheduler._pre_render_events = function(e, t) {
        ...
        if (e = this._table_view ? this._pre_render_events_table(e, t) : this._pre_render_events_line(e, t), this._table_view) if (t) this._colsS.heights = s;
        else {
            var r = n.firstChild;
            if (r.rows) {
                ...
                v = f,
                m = f + "px";
                this.config.multi_day_height_limit && (v = Math.min(f, this.config.multi_day_height_limit), m = v + "px"),
                ...
                a[0] = 0,
                v != f && (n.style.top = parseInt(n.style.top) + 2 + "px", p.style.overflowY = "auto", x.style.position = "fixed", x.style.top = "", x.style.left = "")
            }
        }
        return e
    },
    ...
    scheduler._pre_render_events_line = function(e, t) {
        ...
        for (var a = 0; a < e.length; a++) {
            ...
            o = r.getHours(),
            l = d.getHours();
            if (n._sday = this._get_event_sday(n), this._ignores[n._sday]) e.splice(a, 1),
            a--;
            else {
                if (i[n._sday] || (i[n._sday] = []), !t) {
                    ...
                    if (h.length && (h[h.length - 1]._inner = !0), !g) if (h.length) if (h.length <= h[h.length - 1]._sorder) {
                        if (h[h.length - 1]._sorder) for (f = 0; f < h.length; f++) {
                            for (var v = !1,
                            m = 0; m < h.length; m++) if (h[m]._sorder == f) {
                                v = !0;
                                break
                            }
                            if (!v) {
                    ...
                    h.length > (h.max_count || 0) ? (h.max_count = h.length, n._count = h.length) : n._count = n._count ? n._count: 1
    ...
    scheduler._pre_render_events_table = function(e, t) {
        this._time_order(e);
        for (var i, s = [], a = [[], [], [], [], [], [], []], n = this._colsS.heights, r = this._cols.length, d = {},
        o = 0; o < e.length; o++) {
            var l = e[o],
            h = l.id;
            d[h] || (d[h] = {
            ...
            c = i || l.start_date,
            u = l.end_date;
            c < this._min_date && (_.first_chunk = !1, c = this._min_date),
            u > this._max_date && (_.last_chunk = !1, u = this._max_date);
            ...
            if (l._sday = g % r, !this._ignores[l._sday] || !l._timed) {
                ...
                if (l._sorder && t || (l._sorder = v), l._sday + l._length <= r) i = null,
                s.push(l),
                m[v] = l,
    ...
    scheduler.render_event_bar = function(e) {
        ...
        if (n) {
            ...
            _ = d && (e._timed || l),
            c = d && (e._timed || h),
            u = "dhx_cal_event_clear"; (!e._timed || d) && (u = "dhx_cal_event_line"),
    ...
    scheduler._locate_event = function(e) {
        for (var t = null; e && !t && e.getAttribute;) t = e.getAttribute("event_id"),
        e = e.parentNode;
        return t
    },
    ...
    scheduler._load = function(e, t) {
        if (e = e || this._load_url) {
            ...
            if (t = t || this._date, this._load_mode) {
                ...
                i = t;
                for (var a = !0; i < this._max_date;) i = this.date.add(i, 1, this._load_mode),
                this._loaded[s(t)] && a ? t = this.date.add(t, 1, this._load_mode) : a = !1;
                var n = i;
                do i = n,
                n = this.date.add(i, -1, this._load_mode);
                while (n > t && this._loaded[s(n)]);
                if (t >= i) return ! 1;
                for (dhtmlxAjax.get(e + "&from=" + s(t) + "&to=" + s(i),
                function(e) {
                    scheduler.on_load(e)
                }); i > t;) this._loaded[s(t)] = !0,
    ...
    scheduler.on_load = function(e) {
        ...
        if (this._process && "xml" != this._process) try {
            ...
            i = !0
        } else t = this._magic_parser(e),
        t || (i = !0);
        i && (this.callEvent("onLoadError", [e.xmlDoc]), t = []),
    ...
    scheduler.json.parse = function(data) {
        "string" == typeof data && (scheduler._temp = eval("(" + data + ")"), data = scheduler._temp ? scheduler._temp.data || scheduler._temp.d || scheduler._temp: []),
    ...
    scheduler.load = function(e, t) {
        "string" == typeof t && (this._process = t, t = arguments[2]),
        this._load_url = e,
        this._after_call = t,
    ...
    scheduler.ical = {
        ...
        parse_param: function(e, t) {
            ...
            if ( - 1 != i) {
                ...
                "summary" == s ? s = "text": "dtstart" == s ? (s = "start_date", a = this.parse_date(a, 0, 0)) : "dtend" == s && (s = "end_date", a = this.parse_date(a, 0, 0)),
                t[s] = a
            }
        },
    ...
    scheduler.formSection = function(e) {
        ...
        r = {
            ...
            node: n,
            getValue: function(e) {
                return scheduler.form_blocks[s.type].get_value(n, e || {},
                s)
            },
            setValue: function(e, t) {
                return scheduler.form_blocks[s.type].set_value(n, e, t || {},
                s);
            }
        },
    ...
    scheduler.form_blocks = {
        ...
        select: {
            ...
            set_value: function(e, t, i, s) {
                var a = e.firstChild; ! a._dhx_onchange && s.onchange && (a.onchange = s.onchange, a._dhx_onchange = !0),
        ...
        time: {
            ...
            set_value: function(e, t, i, s) {
                function a(e, t, i) {
                    for (var a = s._time_values,
                    n = 60 * i.getHours() + i.getMinutes(), r = n, d = !1, o = 0; o < a.length; o++) {
                        var h = a[o];
                        if (h === n) {
                            d = !0;
                            break
    ...
    scheduler._fill_lightbox = function(e, t) {
        ...
        for (var a = this.config.lightbox.sections,
        n = 0; n < a.length; n++) {
            var r = a[n],
    ...
    scheduler._lightbox_out = function(e) {
        for (var t = this.config.lightbox.sections,
        i = 0; i < t.length; i++) {
    ...
    scheduler.save_lightbox = function() {
        var e = this._lightbox_out({},
        this._lame_copy(this.getEvent(this._lightbox_id))); (!this.checkEvent("onEventSave") || this.callEvent("onEventSave", [this._lightbox_id, e, this._new_event])) && (this._empty_lightbox(e), this.hide_lightbox())
    },
        ...
        this.getLightbox().onclick = function(e) {
            ...
            default:
                if (t.getAttribute("dhx_button")) scheduler.callEvent("onLightboxButton", [t.className, t, e]);
                    ...
                    var s, a, n; - 1 != t.className.indexOf("dhx_custom_button") && ( - 1 != t.className.indexOf("dhx_custom_button_") ? (s = t.parentNode.getAttribute("index"), n = t.parentNode.parentNode) : (s = t.getAttribute("index"), n = t.parentNode, t = t.firstChild)),
                    s && (a = scheduler.form_blocks[scheduler.config.lightbox.sections[s].type], a.button_click(s, t, n, n.nextSibling))
                }
            }
        },
    ...
    scheduler.getLightbox = function() {
        if (!this._lightbox) {
            ...
            for (var t = this._lightbox_template,
            i = this.config.buttons_left,
            s = 0; s < i.length; s++) t += "<div class='dhx_btn_set dhx_left_btn_set " + i[s] + "_set'><div dhx_button='1' class='" + i[s] + "'></div><div>" + scheduler.locale.labels[i[s]] + "</div></div>";
            ...
            t += "</div>",
            e.innerHTML = t,
            scheduler.config.drag_lightbox && (e.firstChild.onmousedown = scheduler._ready_to_dnd, e.firstChild.onselectstart = function() {
                return ! 1
            },
    ...
    scheduler.attachEvent("onEventIdChange",
    function(e, t) {
    ...
    scheduler._init_touch_events = function() {
        ...
        this.config.touch && (this.xy.scroll_width = 0, window.navigator.msPointerEnabled ? (this._touch_events(["MSPointerMove", "MSPointerDown", "MSPointerUp"],
        function(e) {
            return e.pointerType == e.MSPOINTER_TYPE_MOUSE ? null: e
        },
        function(e) {
            return ! e || e.pointerType == e.MSPOINTER_TYPE_MOUSE;
        }), this._obj.ondblclick = function() {}) : this._touch_events(["touchmove", "touchstart", "touchend"],
        function(e) {
    ...
    scheduler._touch_events = function(e, t, i) {
        ...
        function r(e) {
            ...
            h && (scheduler._on_mouse_up(t(e || event)), scheduler._temp_touch_block = !1),
        ...
        s(this._els.dhx_cal_data[0], "contextmenu",
        function(e) {
        ...
        function(e) {
            if (!i(e)) {
                ...
                var a = new Date;
                if (!_ && !h && 250 > a - u) return scheduler._click.dhx_cal_data(s),
                ...
                if (u = a, !_ && !h && scheduler.config.touch_drag) {
                    ...
                    l = setTimeout(function() {
                        ...
                        scheduler._drag_mode && "create" != scheduler._drag_mode && scheduler.for_rendered(scheduler._drag_id,
                        function(e, t) {
                            e.style.display = "none",
                            scheduler._rendered.splice(t, 1)
                        }),
        ...
        s(this._els.dhx_cal_data[0], e[2],
        function(e) {
    ...
    scheduler._dp_init = function(e) {
        ...
        function(t) { ! this._loading && this._validId(t) && e.setUpdated(t, !0, "inserted")
        }),
        ...
        function(t) { ! this._loading && this._validId(t) && e.setUpdated(t, !0, "updated");
        }),
        scheduler.attachEvent("onClearAll",
        function() {
            e._in_progress = {},
            e._invalid = {},
            e.updatedRows = [],
        ...
        e.fn.dhx_scheduler = function(s) {
            if ("string" != typeof s) {
                ...
                return this.each(function() {
                    if (this && this.getAttribute) if (this.getAttribute("dhxscheduler")) a.push(window[this.getAttribute("dhxscheduler")]);
                    else {
                        var e = "scheduler";
