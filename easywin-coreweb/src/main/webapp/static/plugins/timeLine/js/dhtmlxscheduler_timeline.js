    ...
    e._temp_matrix_scope = function() {
        function t() {
            ...
            for (var n = 0; n < t.length; n++) {
                ...
                for (; this._trace_x[r] && t[n].end_date > this._trace_x[r];) a[i][r] || (a[i][r] = []),
                a[i][r].push(t[n]),
                r++
            }
            return a
        ...
        function n(t, a) {
            ...
            i = this._trace_x[n];
            return a && +t != +this._trace_x[n] && (i = this._trace_x[n + 1] ? this._trace_x[n + 1] : e.date.add(this._trace_x[n], this.x_step, this.x_unit)),
            new Date(i)
        }
        function i(t) {
            if (e._ignores_detected) for (var a, n, i, r, d = 0; d < t.length; d++) {
                ...
                i || a != n || e._ignores[n] || +r.end_date > +this._trace_x[n] && (i = !0),
                i || (t.splice(d, 1), d--)
            }
        }
        function r(t) {
            ...
            if (t && "cell" != this.render) {
                ...
                for (var r = [], d = t.length, l = 0; d > l; l++) {
                    ...
                    if (r.length && (r[r.length - 1]._inner = !0), !c) if (r.length) if (r.length <= r[r.length - 1]._sorder) {
                        if (r[r.length - 1]._sorder) for (var p = 0; p < r.length; p++) {
                            for (var v = !1,
                            m = 0; m < r.length; m++) if (r[m]._sorder == p) {
                                v = !0;
                                break
                            }
                            if (!v) {
                    ...
                    r.push(o),
                    r.length > (r.max_count || 0) ? (r.max_count = r.length, o._count = r.length) : o._count = o._count ? o._count: 1;
                }
        ...
        function d(a) {
            ...
            else for (var d = e.get_visible_events(), l = this.order, o = 0; o < d.length; o++) {
                var s = d[o],
                _ = s[this.y_property],
                c = this.order[_];
            ...
            for (var p = 0,
            v = 0; v < e._cols.length; v++) p += e._cols[v];
            var m = new Date,
            g = e._cols.length - e._ignores_detected;
            m = (e.date.add(m, this.x_step * g, this.x_unit) - m - (this._start_correction + this._end_correction) * g) / p,
            this._step = m,
            this._summ = p;
            ...
            for (var v = 0; v < this.y_unit.length; v++) {
                ...
                this.section_autoheight && (this.y_unit.length * y.height < a.offsetHeight && (y.height = 44), this._section_height[this.y_unit[v].key] = y.height),
                y.td_className || (y.td_className = "dhx_matrix_scell" + (e.templates[this.name + "_scaley_class"](this.y_unit[v].key, this.y_unit[v].label, this.y_unit[v]) ? " " + e.templates[this.name + "_scaley_class"](this.y_unit[v].key, this.y_unit[v].label, this.y_unit[v]) : "")),
                y.td_content || (y.td_content = e.templates[this.name + "_scale_label"](this.y_unit[v].key, this.y_unit[v].label, this.y_unit[v])),
                e._merge(y, {
                    tr_className: "",
                ...
                if (this.fit_events) {
                    ...
                    y.style_height = "height:" + y.height + "px;",
                    this._section_height[this.y_unit[v].key] = y.height
                }
                if (n += "<tr class='" + y.tr_className + "' style='" + y.style_height + "'><td class='" + y.td_className + "' style='" + y.style_width + " height:" + (y.height - 1) + "px;'>" + y.td_content + "</td>", "cell" == this.render) for (var o = 0; o < e._cols.length; o++) n += e._ignores[o] ? "<td></td>": "<td class='dhx_matrix_cell " + e.templates[this.name + "_cell_class"](i[v][o], this._trace_x[o], this.y_unit[v]) + "' style='width:" + (e._cols[o] - 1) + "px'><div style='width:" + (e._cols[o] - 1) + "px'>" + e.templates[this.name + "_cell_value"](i[v][o], this._trace_x[o], this.y_unit[v]) + "</div></td>";
                    ...
                    n += x,
                    n += "<table class='" + y.table_className + "' cellpadding='0' cellspacing='0' style='" + y.summ_width + " " + y.style_height + "' >";
        ...
        function l(t) {
            ...
            for (var i = (this.x_size + (t ? e._ignores_detected: 0), 0), r = 0; + n > +a;) if (this._trace_x[r] = new Date(a), a = e.date.add(a, this.x_step, this.x_unit), e.date[this.x_unit + "_start"] && (a = e.date[this.x_unit + "_start"](a)), e._ignores[r] || i++, r++, t) if (i < this.x_size && !( + n > +a)) n = e.date["add_" + this.name + "_private"](n, (this.x_length || this.x_size) * this.x_step);
        ...
        function o(t) {
            ...
            for (var o = e._min_date_timeline = e._min_date,
            _ = e.config.preserve_scale_length,
            c = l.call(this, _), u = c.displayed, h = c.total, p = 0; h > p; p++) e._ignores[p] ? (e._cols[p] = 0, u++) : e._cols[p] = Math.floor(i / (u - p)),
            i -= e._cols[p],
            r[p + 1] = r[p] + e._cols[p];
            if (t.innerHTML = "<div></div>", this.second_scale) {
                for (var m = this.second_scale.x_unit,
                g = [this._trace_x[0]], f = [], b = [this.dx, this.dx], y = 0, x = 0; x < this._trace_x.length; x++) {
                ...
                for (var S = 0; S < g.length; S++) {
                    ...
                    T.className = "dhx_scale_bar dhx_second_scale_bar" + (O ? " " + O: ""),
                    e.set_xy(T, f[S] - 1, n - 3, b[S], 0),
                    T.innerHTML = e.templates[this.name + "_second_scale_date"](N),
                    E.appendChild(T)
                }
            }
            e.xy.scale_height = n,
            t = t.lastChild;
            for (var C = 0; C < this._trace_x.length; C++) if (!e._ignores[C]) {
                o = this._trace_x[C],
                e._render_x_header(C, r[C], o, t);
        ...
        function c(t) {
            if (_.call(this, t), t) {
                this.second_scale && !this._header_resized && (this._header_resized = e.xy.scale_height, e.xy.scale_height *= 2, e._els.dhx_cal_header[0].className += " dhx_second_cal_header"),
                e.set_sizes(),
                e._init_matrix_tooltip();
                var a = e._min_date;
                o.call(this, e._els.dhx_cal_header[0]),
                d.call(this, e._els.dhx_cal_data[0]),
                e._min_date = a,
                e._els.dhx_cal_date[0].innerHTML = e.templates[this.name + "_date"](e._min_date, e._max_date),
        ...
        function h(t, a, n) {
            if ("cell" == t.render) {
                ...
                if (r.sort(function(e, t) {
                    ...
                    d.className = "dhx_year_tooltip",
                    document.body.appendChild(d),
                    d.onclick = e._click.dhx_cal_data
                }
                for (var l = "",
                o = 0; o < r.length; o++) {
                    var s = r[o].color ? "background-color:" + r[o].color + ";": "",
                    _ = r[o].textColor ? "color:" + r[o].textColor + ";": "";
                    l += "<div class='dhx_tooltip_line' event_id='" + r[o].id + "' style='" + s + _ + "'>",
                    l += "<div class='dhx_tooltip_date'>" + (r[o]._timed ? e.templates.event_date(r[o].start_date) : "") + "</div>",
                    l += "<div class='dhx_event_icon icon_details'>&nbsp;</div>",
                    l += e.templates[t.name + "_tooltip"](r[o].start_date, r[o].end_date, r[o]) + "</div>"
                }
                e._tooltip.style.display = "",
                e._tooltip.style.top = "0px",
                document.body.offsetWidth - n.left - e._tooltip.offsetWidth < 0 ? e._tooltip.style.left = n.left - e._tooltip.offsetWidth + "px": e._tooltip.style.left = n.left + a.src.offsetWidth + "px",
                e._tooltip.date = i,
                e._tooltip.innerHTML = l,
        ...
        function p(e) {
            ...
            a = 0; a < t.length; a++) if (t[a] == e) return a;
            return - 1
        }
        function v(e) {
            e = e || event;
        ...
        e.createTimelineView = function(t) {
            ...
            e._merge(t, {
                ...
                _logic: function(t, a, n) {
                    var i = {};
                    return e.checkEvent("onBeforeSectionRender") && (i = e.callEvent("onBeforeSectionRender", [t, a, n])),
                    i
                }
            }),
            ...
            e.render_data = function(n, i) {
                ...
                if (i && !t.show_unassigned && "cell" != t.render) for (var r = 0; r < n.length; r++) this.clear_event(n[r]),
            ...
            e.date["add_" + t.name] = function(a, n, i) {
                ...
                if ("minute" == t.x_unit || "hour" == t.x_unit) {
                    ...
                    if (l * d % 1440) if ( + e.date.date_part(new Date(a)) == +e.date.date_part(new Date(r))) t.x_start += n * d;
                    else {
                        var o = 1440 / (d * l) - 1,
                        s = Math.round(o * d);
            ...
            e["mouse_" + t.name] = function(a) {
                ...
                this._drag_id && (i = this.getEvent(this._drag_id)),
                a.x -= t.dx;
                ...
                this._resolve_timeline_section(t, a),
                a.section && this._update_timeline_section({
                    pos: a,
                    event: this.getEvent(this._drag_id),
                    view: t
                }),
                a.y = Math.round((this._correct_shift(r, 1) - this._min_date) / (6e4 * this.config.time_step)),
                a.shift = this.config.time_step;
                var o = this._is_pos_changed(this._drag_pos, a);
                return this._drag_pos && o && (this._drag_event._dhx_changed = !0),
                o || this._drag_pos.has_moved || (a.force_redraw = !1),
                a
            }
        },
        e._get_timeline_event_height = function(e, t) {
            ...
            n = t.event_dy;
            return "full" == t.event_dy && (n = t.section_autoheight ? t._section_height[a] - 6 : t.dy - 3),
            t.resize_events && (n = Math.max(Math.floor(n / e._count), t.event_min_dy)),
            n
        },
        e._get_timeline_event_y = function(t, a) {
            var n = t,
            i = 2 + n * a + (n ? 2 * n: 0);
            return e.config.cascade_event_display && (i = 2 + n * e.config.cascade_event_margin + (n ? 2 * n: 0)),
            i
        },
        //渲染
        e.render_timeline_event = function(t, n) {
            ...
            c = o + _ + 2; (!this._events_height[i] || this._events_height[i] < c) && (this._events_height[i] = c);
            var u = e.templates.event_class(t.start_date, t.end_date, t);
            u = "dhx_cal_event_line " + (u || ""),
            t._no_drag_move && (u += " no_drag_move");
...
//            v = e.templates.event_bar_text(t.start_date, t.end_date, t),
        ...
        e._locate_cell_timeline = function(t) {
            t = t || event;
            for (var a = t.target ? t.target: t.srcElement, n = {},
            i = e.matrix[e._mode], r = e.getActionData(t), d = e._ignores, l = 0, o = 0; o < i._trace_x.length - 1 && !( + r.date < i._trace_x[o + 1]); o++) d[o] || l++;
            n.x = 0 === l ? 0 : o,
            n.y = i.order[r.section];
            ...
            return _ ? (n.x = -1, n.src = a, n.scale = !0) : n.x = o,
            n
        };
        ...
        var g = e.dblclick_dhx_marked_timespan ||
        function() {};
        ...
        e.attachEvent("onCellDblClick",
        function(t, a, n, i, r) {
            if (!this.config.readonly && ("dblclick" != r.type || this.config.dblclick_create)) {
                var d = e.matrix[e._mode],
                l = {};
                l.start_date = d._trace_x[t],
                l.end_date = d._trace_x[t + 1] ? d._trace_x[t + 1] : e.date.add(d._trace_x[t], d.x_step, d.x_unit),
                d._start_correction && (l.start_date = new Date(1 * l.start_date + d._start_correction)),
                d._end_correction && (l.end_date = new Date(l.end_date - d._end_correction)),
                l[d.y_property] = d.y_unit[a].key,
                e.addEventNow(l, null, r)
            }
        }),
        ...
        e._render_marked_timespan = function(t, n, i, r, d) {
            ...
            if (e.matrix && e.matrix[e._mode]) {
                ...
                s = [i];
                    ...
                    else for (var h in u) u.hasOwnProperty(h) && (s.push(h), _.push(l._scales[h]))
                }
                var r = r ? new Date(r) : e._min_date,
                d = d ? new Date(d) : e._max_date;
                r.valueOf() < e._min_date.valueOf() && (r = new Date(e._min_date)),
                d.valueOf() > e._max_date.valueOf() && (d = new Date(e._max_date));
                ...
                for (var g = t.zones,
                b = e._get_css_classes_by_config(t), y = 0; y < s.length; y++) {
                    n = _[y],
                    i = s[y];
                    for (var p = 0; p < v.length; p++) for (var x = v[p], k = 0; k < g.length; k += 2) {
                        var w = g[k],
                        D = g[k + 1],
                        ...
                        if (M > r && d > E) {
                            ...
                            S.style.cssText = "height: " + C + "px; left: " + N + "px; width: " + T + "px; top: 0;",
        ...
        e._on_scale_add_marker = function(t, a) {
            if (e.matrix && e.matrix[e._mode]) {
                ...
                if (i && e.matrix && e.matrix[e._mode]) for (var r = e._mode,
                d = e._min_date,
                l = e._max_date,
                o = i.global,
                s = e.date.date_part(new Date(d)); l > s; s = e.date.add(s, 1, "day")) {
                    var _ = +s,
                    c = s.getDay(),
                    u = [],
                    h = o[_] || o[c];
                    if (u.push.apply(u, e._get_configs_to_render(h)), i[r] && i[r][a]) {
                        ...
                        p.push.apply(p, e._get_configs_to_render(v)),
                        p.length && (u = p)
                    }
        ...
        e._resolve_timeline_section = function(e, t) {
            ...
            this._drag_event && !this._drag_event._orig_section && (this._drag_event._orig_section = e.y_unit[a].key),
            t.fields = {},
        ...
        e._get_date_index = function(e, t) {
            for (var a = 0,
            n = e._trace_x; a < n.length - 1 && +t >= +n[a + 1];) a++;
            return a
        },
        e._timeline_drag_date = function(t, a) {
            ...
            l = 0,
            o = 0;
            for (o; o <= this._cols.length - 1; o++) if (i = this._cols[o], l += i, l > d.x) {
                n = (d.x - (l - i)) / i,
                n = 0 > n ? 0 : n;
                break
            }
            if (r.round_position) {
                var s = 1;
                e.getState().drag_mode && "move" != e.getState().drag_mode && (s = .5),
                n >= s && o++,
                n = 0
            }
            if (0 === o && this._ignores[0]) for (o = 1, n = 0; this._ignores[o];) o++;
            else if (o == this._cols.length && this._ignores[o - 1]) {
                for (o = this._cols.length - 1, n = 0; this._ignores[o];) o--;
                o++
            }
            var _;
            if (o >= r._trace_x.length) _ = e.date.add(r._trace_x[r._trace_x.length - 1], r.x_step, r.x_unit),
            r._end_correction && (_ = new Date(_ - r._end_correction));
            else {
        ...
        e.attachEvent("onBeforeTodayDisplayed",
        function() {
        ...
        function() {
            for (var t in e.matrix) {
                ...
                e._date && a.name == e._mode && e.setCurrentView(e._date, e._mode)
            }
        }),
        e.attachEvent("onSchedulerResize",
        function() {
            if (e.matrix[this._mode]) {
                var t = e.matrix[this._mode];
                return e._renderMatrix.call(t, !0, !0),
                !1
            }
            return ! 0
        }),
        ...
        function(t, a, n) {
            if ("resize" == a) {
                var i = n.target || n.srcElement; (i.className || "").indexOf("dhx_event_resize_end") < 0 ? e._drag_from_start = !0 : e._drag_from_start = !1;
            }
            return ! 0
        })
    },
